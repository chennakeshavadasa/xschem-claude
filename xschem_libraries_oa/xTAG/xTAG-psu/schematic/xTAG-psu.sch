...
C {xTAG/max882} 910 -610 0 0 {name=U30
device=MAX882 
footprint=SO8}
C {devices/res} 510 -560 0 0 {name=R32
value=100k
footprint=sm0805
device=resistor
m=1}
C {devices/res} 510 -460 0 0 {name=R33
value=39k
footprint=sm0805
device=resistor
m=1}
C {devices/capa} 410 -460 0 0 {name=C31
m=1
value=2.2u
footprint=sm1206
device="POLARIZED_CAPACITOR"}
C {devices/capa} 330 -460 0 0 {name=C30
m=1
value=100n
footprint=sm1206
device="CAPACITOR"}
C {devices/res} 220 -650 3 1 {name=R30
value=0
footprint=sm0805
device=resistor
m=1}
C {devices/res} 220 -570 3 1 {name=R31
value=0
footprint=sm0805
device=resistor
m=1}
C {devices/ipin} 170 -650 0 0 {name=p1 lab=usb_power}
C {devices/ipin} 170 -570 0 0 {name=p1 lab=jtag_power}
C {devices/capa} 1210 -460 0 0 {name=C32
m=1
value=2.2u
footprint=sm1206
device="POLARIZED_CAPACITOR"}
C {devices/vdd} 1250 -570 0 0 {name=l1 lab=V3_3}
C {devices/opin} 1350 -650 0 0 {name=p1 lab=pon_reset_}
C {devices/gnd} 710 -410 0 0 {name=l1 lab=GND}
