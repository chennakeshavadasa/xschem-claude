...
C {xTAG/cy7c64603-52nc} 1020 -630 0 0 {name=U1 device=cy7c64603-52nc footprint=cy7c64603_qfp}
C {devices/vdd} 720 -1300 0 0 {name=l2 lab=V3_3}
C {devices/res} 960 -1380 3 1 {name=R17
value=1MEG
footprint=1206
device=resistor
m=1}
C {devices/crystal} 960 -1310 1 0 {name=X1
value=12MHz
footprint=CRYSTAL 300
device=CRYSTAL}
C {devices/capa} 1050 -1380 3 1 {name=C5
m=1
value=30p
footprint=sm1206
device="ceramic capacitor"}
C {devices/capa} 870 -1380 1 0 {name=C4
m=1
value=30p
footprint=sm1206
device="ceramic capacitor"}
C {devices/gnd} 1080 -1380 0 0 {name=l3 lab=GND}
C {devices/gnd} 840 -1380 0 1 {name=l4 lab=GND}
C {xTAG/24cxx} 200 -450 0 0 {name=U2
power=V3_3
ground=GND}
C {devices/res} 370 -710 0 0 {name=R5
value=0
footprint=sm0805
device=resistor
m=1}
C {devices/res} 370 -630 0 0 {name=R6
value=0
footprint=sm0805
device=resistor
m=1}
C {devices/noconn} 370 -680 3 0 {name=l5}
C {devices/gnd} 370 -600 0 0 {name=l6 lab=GND}
C {devices/vdd} 370 -740 0 0 {name=l7 lab=V3_3}
C {devices/res} 530 -550 3 1 {name=R7
value=10k
footprint=sm0805
device=resistor
m=1}
C {devices/noconn} 660 -510 3 0 {name=l8}
C {devices/res} 530 -470 3 1 {name=R8
value=10k
footprint=sm0805
device=resistor
m=1}
C {devices/vdd} 470 -550 0 0 {name=l9 lab=V3_3}
C {devices/noconn} 280 -470 1 1 {name=l10}
C {devices/gnd} 120 -360 0 0 {name=l11 lab=GND}
C {devices/res} 40 -480 0 0 {name=R10
value=0
footprint=sm0805
device=resistor
m=1}
C {devices/gnd} 40 -450 0 0 {name=l12 lab=GND}
C {devices/res} 40 -560 0 0 {name=R9
value=0
footprint=sm0805
device=resistor
m=1}
C {devices/noconn} 40 -530 3 0 {name=l13}
C {devices/vdd} 40 -590 0 0 {name=l14 lab=V3_3}
C {devices/res} 420 -480 0 0 {name=R12
value=0
footprint=sm0805
device=resistor
m=1}
C {devices/res} 360 -480 0 0 {name=R11
value=0
footprint=sm0805
device=resistor
m=1}
C {devices/vdd} 390 -520 0 0 {name=l15 lab=V3_3}
C {devices/jumper} 360 -390 1 0 {name=J1}
C {devices/ipin} 280 -940 0 0 {name=p1 lab=usb_iom}
C {devices/ipin} 280 -880 0 0 {name=p2 lab=usb_iop}
C {devices/res} 350 -940 3 1 {name=R3
value=22
footprint=sm0805
device=resistor
m=1}
C {devices/res} 350 -880 3 1 {name=R4
value=22
footprint=sm0805
device=resistor
m=1}
C {devices/res} 350 -1050 3 1 {name=R2
value=1.5k
footprint=sm0805
device=resistor
m=1}
C {devices/ipin} 280 -1120 0 0 {name=p3 lab=reset_}
C {devices/capa-2} 510 -1220 0 0 {name=C2
m=1
value=2.2u
footprint=sm1206
device="polarized_capacitor"}
C {devices/capa} 580 -1220 0 0 {name=C1
m=1
value=100n
footprint=sm1206
device="capacitor"}
C {devices/gnd} 540 -1180 0 0 {name=l16 lab=GND}
C {devices/vdd} 540 -1250 0 0 {name=l17 lab=V3_3}
C {devices/res} 1490 -1190 0 0 {name=R15
value=10k
footprint=sm0805
device=resistor
m=1}
C {devices/res} 1590 -1190 0 0 {name=R16
value=10k
footprint=sm0805
device=resistor
m=1}
C {devices/res} 1700 -1130 3 1 {name=R14
value=10k
footprint=sm0805
device=resistor
m=1}
C {devices/gnd} 1770 -1130 0 0 {name=l18 lab=GND}
C {devices/vdd} 1490 -1240 0 0 {name=l19 lab=V3_3}
C {devices/vdd} 1590 -1240 0 0 {name=l20 lab=V3_3}
C {devices/conn_10x2} 1590 -690 3 0 {name=CONN1 footprint="connector 10 2"}
C {devices/vdd} 1730 -750 0 0 {name=l21 lab=V3_3}
C {devices/gnd} 1790 -730 0 0 {name=l22 lab=GND}
C {devices/ipin} 1790 -530 0 1 {name=p4 lab=tdo_ttl}
C {devices/opin} 1790 -550 0 0 {name=p6 lab=trst_ttl}
C {devices/opin} 1790 -570 0 0 {name=p7 lab=tck_ttl}
C {devices/opin} 1790 -590 0 0 {name=p8 lab=tms_ttl}
C {devices/opin} 1790 -610 0 0 {name=p9 lab=tdi_ttl}
C {devices/capa} 1750 -1290 0 0 {name=C6
m=1
value=100n
footprint=sm1206
device="capacitor"}
C {devices/capa} 1830 -1290 0 0 {name=C7
m=1
value=100n
footprint=sm1206
device="capacitor"}
C {devices/capa} 1910 -1290 0 0 {name=C8
m=1
value=100n
footprint=sm1206
device="capacitor"}
C {devices/capa} 1990 -1290 0 0 {name=C9
m=1
value=100n
footprint=sm1206
device="capacitor"}
C {devices/vdd} 1750 -1340 0 0 {name=l23 lab=V3_3}
C {devices/gnd} 1750 -1240 0 0 {name=l24 lab=GND}
C {devices/gnd} 720 -120 0 0 {name=l25 lab=GND}
C {devices/noconn} 1200 -190 3 0 {name=l26}
C {devices/res} 1340 -100 3 1 {name=R13
value=10k
footprint=sm0805
device=resistor
m=1}
C {devices/vdd} 1410 -140 0 0 {name=l27 lab=V3_3}
C {devices/lab_wire} 1410 -890 0 1 {name=p5 lab=PB0}
C {devices/lab_wire} 1410 -870 0 1 {name=p10 lab=PB1}
C {devices/lab_wire} 1410 -850 0 1 {name=p11 lab=PB2}
C {devices/lab_wire} 1410 -830 0 1 {name=p12 lab=PB3}
C {devices/lab_wire} 1410 -810 0 1 {name=p13 lab=PB4}
C {devices/lab_wire} 1410 -790 0 1 {name=p14 lab=PB5}
C {devices/lab_wire} 1410 -770 0 1 {name=p15 lab=PB6}
C {devices/lab_wire} 1410 -750 0 1 {name=p16 lab=PB7}
C {devices/lab_wire} 1410 -510 0 1 {name=p22 lab=PC5}
C {devices/lab_wire} 1410 -490 0 1 {name=p23 lab=PC6}
C {devices/lab_wire} 1410 -470 0 1 {name=p24 lab=PC7}
C {devices/lab_wire} 1410 -430 0 1 {name=p25 lab=CTL0}
C {devices/lab_wire} 1410 -390 0 1 {name=p26 lab=CTL2}
C {devices/lab_wire} 660 -1050 0 0 {name=p27 lab=DISCON_}
C {devices/lab_wire} 660 -930 0 0 {name=p29 lab=USBDP}
C {devices/lab_wire} 660 -890 0 0 {name=p30 lab=UBDM}
C {devices/lab_wire} 660 -590 0 0 {name=p31 lab=XCLKSEL}
C {devices/lab_wire} 660 -550 0 0 {name=p32 lab=XCLK}
C {devices/lab_wire} 660 -470 0 0 {name=p34 lab=WAKEUP_}
C {devices/lab_wire} 660 -430 0 0 {name=p35 lab=SCL}
C {devices/lab_wire} 660 -390 0 0 {name=p36 lab=SDA}
C {devices/lab_wire} 1380 -1130 0 1 {name=p17 lab=RDY2}
C {devices/lab_wire} 1380 -1090 0 1 {name=p18 lab=PA4_RDY4}
C {devices/lab_wire} 1380 -1050 0 1 {name=p19 lab=PA5_RDY5}
