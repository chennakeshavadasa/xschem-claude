...
C {devices/title-2} 0 0 0 0 {name=l1 
author="Stefan Frederik Schippers"
page=1
pages=1
title="R8C/R33C RULZ LAB BOARD"
lock=truex rev=1.1}
C {rulz-r8c33/usb-minib} 210 -1410 0 0 {name=CONN1
model=usb-minib
...
C {devices/conn_14x1} 2280 -2130 3 1 {name=CONN2
footprint=JUMPER_14
value=DNP
...
C {devices/jumper} 1730 -1800 1 1 {name=JP1
footprint=JUMPER2
device=JUMPER}
C {rulz-r8c33/r8c-33c} 2310 -1230 0 0 {name=U2 device=r8c-33c
footprint=TQFP32_7
...
vendor Renesas"}
C {rulz-r8c33/ft232rl} 860 -1180 0 0 {name=U1
...
vendor digikey"}
C {devices/gnd} 290 -1350 0 0 {name=l2 lab=GND}
C {devices/noconn} 290 -1380 2 0 {name=l3}
C {devices/noconn} 190 -1270 3 0 {name=l4}
C {devices/vdd} 160 -1660 0 0 {name=l5 lab=+5V}
C {devices/led} 160 -1630 0 0 {name=LED8 
model=LED 
...
vendor digikey"}
C {devices/res} 160 -1570 0 0 {name=R5
value=3.3k
footprint=0603
device=resistor
...
vendor digikey"}
C {devices/gnd} 160 -1540 0 0 {name=l6 lab=GND}
C {devices/ind} 440 -1850 3 1 {name=L1
value="600@100"
footprint=0603
device=INDUCTOR
...
vendor digikey"}
C {devices/capa-2} 470 -1760 0 0 {name=C2
value=4.7uF
footprint=0603
...
vendor digikey"}
C {devices/gnd} 410 -1730 0 0 {name=l7 lab=GND}
C {devices/gnd} 470 -1730 0 0 {name=l8 lab=GND}
C {devices/lab_pin} 290 -1850 0 0 {name=l9 sig_type=std_logic lab=RAW_5V}
C {devices/capa} 410 -1760 0 0 {name=C1
value=10nF
footprint=0603
device="capacitor"
...
vendor digikey"}
C {devices/pmos} 700 -1830 1 1 {name=Q1 
model=DMP2035U 
device=DMP2035U
footprint=SOT-523
...
pinnumber(S)=3 
pinnumber(D)=2}
C {devices/capa} 700 -1760 0 0 {name=C3
value=100nF
footprint=0603
device="capacitor"
...
vendor digikey"}
C {devices/gnd} 700 -1730 0 0 {name=l10 lab=GND}
C {devices/res} 800 -1800 3 1 {name=R1
value=1k
footprint=0603
device=resistor
...
vendor digikey"}
C {devices/vdd} 970 -1880 0 0 {name=l11 lab=+5V}
C {devices/led} 1250 -1790 0 0 {name=LED1
model=LED 
device=LTST-C190KGKT
footprint=0603 
value=GREEN
...
vendor_part_number 160-1435-1-ND
vendor digikey"}
C {devices/res} 1250 -1710 0 0 {name=R2
value=1k
footprint=0603
device=resistor
comptag="manufacturer_part_number MCR03EZPFX1001
...
vendor_part_number RHM1.00KHCT-ND
vendor digikey"}
C {devices/lab_wire} 1210 -1440 0 0 {name=l12 sig_type=std_logic lab=URX}
C {devices/led} 1370 -1790 0 0 {name=LED2
model=LED 
device=LTST-C190KGKT
footprint=0603 
value=GREEN
...
vendor_part_number 160-1435-1-ND
vendor digikey"}
C {devices/res} 1370 -1710 0 0 {name=R3
value=1k
footprint=0603
device=resistor
comptag="manufacturer_part_number MCR03EZPFX1001
...
vendor_part_number RHM1.00KHCT-ND
vendor digikey"}
C {devices/lab_wire} 1210 -1400 0 0 {name=l13 sig_type=std_logic lab=UTX}
C {devices/vdd} 1490 -1880 0 0 {name=l14 lab=+5V}
C {devices/capa} 1490 -1820 0 0 {name=C5
value=100nF
footprint=0603
device="capacitor"
comptag="manufacturer_part_number C0603C104K4RACTU
...
vendor_part_number 399-1096-1-ND
vendor digikey"}
C {devices/gnd} 1490 -1790 0 0 {name=l15 lab=GND}
C {devices/vdd} 1630 -1880 0 0 {name=l16 lab=+5V}
C {devices/lab_wire} 1210 -1360 0 0 {name=l17 sig_type=std_logic lab=MODE}
C {devices/lab_wire} 1150 -1560 0 0 {name=l18 sig_type=std_logic lab=PWREN}
C {devices/noconn} 1080 -1320 2 0 {name=l19}
C {devices/lab_wire} 1210 -1200 0 0 {name=l20 sig_type=std_logic lab=RESET}
C {devices/vdd} 2060 -2140 0 0 {name=l21 lab=+5V}
C {devices/gnd} 2170 -2070 0 1 {name=l22 lab=GND}
C {devices/lab_pin} 2090 -860 0 0 {name=p25 lab=P3.5}
C {devices/lab_pin} 2090 -830 0 0 {name=p26 lab=P3.4}
C {devices/lab_pin} 2090 -800 0 0 {name=p27 lab=P3.3}
C {devices/lab_pin} 2020 -1090 0 0 {name=p1 lab=P3.7}
C {devices/lab_pin} 2580 -2040 0 1 {name=p2 lab=P3.5}
C {devices/lab_pin} 2580 -2010 0 1 {name=p3 lab=P3.4}
C {devices/lab_pin} 2580 -1980 0 1 {name=p4 lab=P3.3}
C {devices/lab_pin} 2580 -2070 0 1 {name=p5 lab=P3.7}
C {devices/res} 2490 -2170 0 0 {name=R4
value=3.3k
footprint=0603
device=resistor
comptag="manufacturer_part_number MCR03EZPFX3301
...
vendor_part_number RHM3.30KHCT-ND
vendor digikey"}
C {devices/vdd} 2490 -2200 0 0 {name=l23 lab=+5V}
C {devices/res} 2550 -2170 0 0 {name=R6
value=3.3k
footprint=0603
device=resistor
comptag="manufacturer_part_number MCR03EZPFX3301
...
vendor_part_number RHM3.30KHCT-ND
vendor digikey"}
C {devices/vdd} 2550 -2200 0 0 {name=l24 lab=+5V}
C {devices/vdd} 80 -900 0 0 {name=l25 lab=+5V}
C {devices/capa} 80 -840 0 0 {name=C6
value=100nF
footprint=0603
device="capacitor"
comptag="manufacturer_part_number C0603C104K4RACTU
...
vendor_part_number 399-1096-1-ND
vendor digikey"}
C {devices/gnd} 80 -810 0 0 {name=l26 lab=GND}
C {devices/gnd} 270 -860 0 0 {name=l27 lab=GND}
C {devices/lab_wire} 590 -1200 0 0 {name=l28 sig_type=std_logic lab=3V3OUT}
C {devices/capa} 340 -1120 0 0 {name=C4
value=100nF
footprint=0603
device="capacitor"
comptag="manufacturer_part_number C0603C104K4RACTU
...
vendor_part_number 399-1096-1-ND
vendor digikey"}
C {devices/gnd} 340 -860 0 0 {name=l29 lab=GND}
C {devices/gnd} 410 -860 0 0 {name=l30 lab=GND}
C {devices/lab_wire} 560 -1440 0 0 {name=l35 lab=USBDM}
C {devices/lab_wire} 560 -1400 0 0 {name=l36 lab=USBDP}
C {devices/noconn} 640 -1280 0 0 {name=l31}
C {devices/noconn} 640 -1320 0 0 {name=l32}
C {devices/noconn} 640 -1360 0 0 {name=l33}
C {devices/noconn} 1080 -1120 0 1 {name=l34}
C {devices/noconn} 1080 -1080 0 1 {name=l37}
C {devices/noconn} 1080 -1040 0 1 {name=l38}
C {devices/gnd} 720 -820 0 0 {name=l39 lab=GND}
C {devices/gnd} 780 -820 0 0 {name=l40 lab=GND}
C {devices/gnd} 840 -820 0 0 {name=l41 lab=GND}
C {devices/lab_wire} 570 -1850 0 0 {name=l42 lab=USB_5V}
C {devices/res} 2910 -1370 3 1 {name=R7
value=1k
footprint=0603
device=resistor
comptag="manufacturer_part_number MCR03EZPFX1001
...
vendor_part_number RHM1.00KHCT-ND
vendor digikey"}
C {devices/led} 2970 -1370 3 0 {name=LED3
model=LED 
device=LTST-C190KGKT
footprint=0603 
value=GREEN
...
vendor_part_number 160-1435-1-ND
vendor digikey"}
C {devices/res} 2910 -1260 3 1 {name=R8
value=1k
footprint=0603
device=resistor
comptag="manufacturer_part_number MCR03EZPFX1001
...
vendor_part_number RHM1.00KHCT-ND
vendor digikey"}
C {devices/led} 2970 -1260 3 0 {name=LED4
model=LED 
device=LTST-C190KGKT
footprint=0603 
value=GREEN
...
vendor_part_number 160-1435-1-ND
vendor digikey"}
C {devices/res} 2910 -1150 3 1 {name=R9
value=1k
footprint=0603
device=resistor
comptag="manufacturer_part_number MCR03EZPFX1001
...
vendor_part_number RHM1.00KHCT-ND
vendor digikey"}
C {devices/led} 2970 -1150 3 0 {name=LED5
model=LED 
device=LTST-C190KGKT
footprint=0603 
value=GREEN
...
vendor_part_number 160-1435-1-ND
vendor digikey"}
C {devices/res} 2910 -1040 3 1 {name=R10
value=1k
footprint=0603
device=resistor
comptag="manufacturer_part_number MCR03EZPFX1001
...
vendor_part_number RHM1.00KHCT-ND
vendor digikey"}
C {devices/led} 2970 -1040 3 0 {name=LED6
model=LED 
device=LTST-C190KGKT
footprint=0603 
value=GREEN
...
vendor_part_number 160-1435-1-ND
vendor digikey"}
C {devices/gnd} 3030 -1010 0 0 {name=l43 lab=GND}
C {devices/gnd} 1960 -1210 0 0 {name=l44 lab=GND}
C {devices/res} 1860 -1030 3 1 {name=R15
value=1MEG
footprint=0603
device=resistor
...
vendor digikey"}
C {devices/rgb_led} 2650 -760 0 0 {name=LED7 model=XXX device=RGB_LED value=RGB footprint=LRTB-R98G comptag="manufacturer_part_number LRTB\\ R98G-R7T5-1+S7U-37+P7R-26
manifacturer OSRAM
vendor digikey"}
C {devices/res} 2510 -830 3 1 {name=R11
value=1k
footprint=0603
device=resistor
comptag="manufacturer_part_number MCR03EZPFX1001
...
vendor_part_number RHM1.00KHCT-ND
vendor digikey"}
C {devices/res} 2510 -760 3 1 {name=R12
value=1k
footprint=0603
device=resistor
comptag="manufacturer_part_number MCR03EZPFX1001
...
vendor_part_number RHM1.00KHCT-ND
vendor digikey"}
C {devices/res} 2510 -680 3 1 {name=R13
value=1k
footprint=0603
device=resistor
comptag="manufacturer_part_number MCR03EZPFX1001
...
vendor_part_number RHM1.00KHCT-ND
vendor digikey"}
C {devices/gnd} 2750 -670 0 0 {name=l45 lab=GND}
C {devices/noconn} 2410 -890 1 1 {name=l46}
C {devices/noconn} 2450 -890 1 1 {name=l47}
C {devices/lab_wire} 1210 -1160 0 0 {name=l48 sig_type=std_logic lab=CTS}
C {devices/lab_wire} 1190 -1000 0 1 {name=l49 lab=RTS}
C {devices/lab_wire} 1190 -960 0 1 {name=l50 lab=RXD}
C {devices/lab_wire} 1190 -920 0 1 {name=l51 lab=TXD}
C {devices/lab_wire} 2000 -1250 0 1 {name=l52 lab=XOUT}
C {devices/lab_wire} 2010 -1170 0 1 {name=l53 lab=XIN}
C {devices/crystal-2} 1860 -890 3 0 {name=X1
value=18.43MHz
footprint=res3-e15mm 300
device=CRYSTAL_module comptag="manufacturer_part_number AWSCR-18.43CV-T
manifacturer Abracon"}
C {devices/gnd} 1860 -860 0 0 {name=l54 lab=GND}
C {devices/launcher} 1670 -2300 0 0 {name=h1
descr="Ctrl-click to go to Delorie's 
project page for info" 
url="http://www.delorie.com/electronics/rulz"}
C {devices/noconn} 230 -1270 1 1 {name=l55}
