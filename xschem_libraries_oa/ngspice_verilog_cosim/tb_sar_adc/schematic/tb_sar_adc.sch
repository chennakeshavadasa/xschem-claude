...
C {devices/code_shown} 700 -440 0 0 {name=COMMANDS only_toplevel=false value="
.param VCC=3.3
.control
  save all
  tran 10n 250u
...
C {devices/launcher} 150 -490 0 0 {name=h5
descr="load waves" 
