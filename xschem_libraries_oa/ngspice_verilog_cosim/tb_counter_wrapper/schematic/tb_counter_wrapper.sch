...
C {devices/code_shown} 0 -1110 0 0 {name=COMMANDS only_toplevel=false value="
.param VDD=1.8
...
.endc
"}
C {devices/launcher} 630 -550 0 0 {name=h5
descr="load waves" 
...
C {ngspice_verilog_cosim/counter} 530 -430 0 0 {name=a1 model=counter
