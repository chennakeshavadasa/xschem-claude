...
C {devices/code_shown} 10 -740 0 0 {
name=CONTROL 
...
.endc
"}
C {devices/launcher} 935 -85 0 0 {name=h2 
descr="Simulate" 
...
C {devices/res} 780 -150 0 0 {name=RLOAD value=30 footprint=1206 device=resistor m=1}
C {devices/lab_pin} 800 -330 2 0 {name=l6 lab=BATT}
C {devices/lab_pin} 780 -100 0 0 {name=l2 lab=0}
C {devices/capa} 680 -150 0 0 {name=C1 m=1 value="20u ic=42" footprint=1206 device="ceramic capacitor"}
C {devices/lab_pin} 680 -100 0 0 {name=l7 lab=0}
C {devices/lab_wire} 420 -330 0 1 {name=l10 lab=DIODE}
C {devices/lab_pin} 80 -330 0 0 {name=l11 lab=SUPPLY}
C {devices/ammeter} 780 -210 0 1 {name=vbatt}
C {devices/launcher} 1160 -90 0 0 {name=h5
descr="load waves" 
tclcommand="xschem raw_read $netlist_dir/buck_boost.raw tran"
}
C {devices/ipin} -50 -430 0 0 {name=p3 lab=PWM1}
C {devices/ammeter} 370 -330 1 0 {name=vdiode}
C {devices/diode} 530 -330 1 0 {name=XD2 model=STPST15H100SB area=1
...
hide_texts=true
attach=XD2}
C {devices/lab_pin} 80 -100 0 0 {name=l3 lab=0}
C {devices/ind} 300 -210 0 0 {name=l8 value="50u ic=5"
hide_texts=true
attach=l8}
C {devices/res} 300 -150 0 0 {name=Rind1 value=0.05 footprint=1206 device=resistor m=1
hide_texts=true
attach=Rind1}
C {devices/lab_wire} 150 -430 0 1 {name=l4 lab=G1}
C {ngspice/buf_ngspice} 70 -430 0 0 {name=x1 RUP=10 RDOWN=10}
C {devices/vsource} 80 -200 0 0 {name=VSUPPLY value=12 savecurrent=false}
C {devices/lab_pin} 300 -100 0 0 {name=l12 lab=0}
C {devices/pmos3} 150 -350 3 1 {name=XM1 model=irf5305 m=1
device_model="
...
"}
C {devices/ammeter} 250 -330 3 1 {name=vm1}
C {devices/ammeter} 300 -280 0 1 {name=vind}
