...
C {devices/title} 160 -40 0 0 {name=l1 author="Stefan Schippers"}
C {devices/code_shown} 180 -310 0 0 {name=CONTROL
value="tcleval(
.option savecurrents
.control
...
C {devices/code} 20 -240 0 0 {name=MODELS value=".MODEL DIODE D(IS=1.139e-08 RS=0.99 CJO=9.3e-12 VJ=1.6 M=0.411 BV=30 EG=0.7 ) 
.MODEL swmod SW(VT=0.5 VH=0.01 RON=0.01 ROFF=10000000)
"}
C {devices/lab_pin} 650 -530 0 1 {name=l4  lab=PANEL }
C {devices/lab_pin} 800 -180 0 0 {name=l6  lab=0 }
C {devices/ammeter} 1070 -440 3 0 {name=Vled}
C {devices/ind} 890 -610 3 1 {name=L2
m=1
value=40u
footprint=1206
device=inductor
hide_texts=true
attach=L2}
C {devices/lab_pin} 1280 -440 0 1 {name=l7  lab=LED }
C {devices/lab_pin} 820 -550 0 1 {name=l9  lab=SW }
C {devices/capa} 1010 -280 0 0 {name=C1
m=1
value=500n
footprint=1206
...
hide_texts=true
attach=C1}
C {devices/lab_pin} 1010 -400 0 1 {name=l10  lab=VO }
C {devices/lab_pin} 360 -610 0 0 {name=l3  lab=PANEL }
C {devices/ammeter} 970 -610 3 0 {name=Vind}
C {devices/isource_table} 1100 -330 0 0 {name=G2[9..0] CTRL="V(LED)" TABLE="
+ (0, 0)
+ (4.8, 5m)
+ (5.2, 15m)
+ (5.6, 46m)
...
C {devices/ammeter} 610 -610 3 0 {name=Vsw}
C {devices/ammeter} 820 -360 2 0 {name=Vdiode}
C {devices/spice_probe} 1120 -440 0 0 {name=p1 analysis=tran}
C {devices/spice_probe} 650 -530 0 0 {name=p2 analysis=tran}
C {devices/spice_probe} 820 -510 0 1 {name=p3 analysis=tran}
C {devices/launcher} 1080 -1140 0 0 {name=h3 
descr="Reload Waves" 
tclcommand="
xschem raw_read $netlist_dir/[file tail [file rootname [xschem get current_name]]].raw tran
"
}
C {ngspice/pv_ngspice} 360 -450 0 0 {name=X1  m=1 isc=6.8 n=36}
C {devices/lab_pin} 360 -370 0 0 {name=l12  lab=0 }
C {devices/capa} 500 -500 0 0 {name=C11
m=1
value=10u
footprint=1206
device="ceramic capacitor"}
C {devices/lab_pin} 500 -370 0 0 {name=l90  lab=0 }
C {devices/ammeter} 430 -530 3 1 {name=Vpanel}
C {ngspice/diode_ngspice} 820 -460 2 0 {name=X2  m=1 Roff=1e9 Ron=0.1}
C {devices/switch_ngspice} 760 -610 1 0 {name=S1 model=swmod}
C {devices/lab_pin} 740 -650 0 0 {name=l5  lab=0 }
C {devices/ammeter} 560 -530 3 1 {name=Vpanel1}
C {devices/ammeter} 500 -420 0 0 {name=Vcap}
C {devices/vsource} 160 -390 0 0 {name=Vfade value="pwl 0 1 1m 0"}
C {devices/lab_pin} 160 -340 0 0 {name=l8  lab=0 }
C {devices/ngspice_get_expr} 1120 -370 0 0 {name=r29 
node="[format %.4g [expr \{[ngspice::get_voltage led] * [ngspice::get_current vled]\}]] W"
descr = power
}
C {devices/vsource} 610 -1040 0 0 {name=Vtriang value="pulse 0 1 0 2u 2u 1f 4u"}
C {devices/lab_pin} 610 -990 0 0 {name=l11  lab=0 }
C {devices/lab_pin} 770 -1080 0 1 {name=l14
lab=TRIANG }
C {devices/vsource} 550 -790 0 0 {name=Vref value=7}
C {devices/lab_pin} 550 -760 0 0 {name=l17  lab=0 }
C {devices/lab_pin} 760 -720 0 0 {name=l13  lab=CTRL1 }
C {ngspice/comp_ngspice} 660 -890 0 0 {name=x3 GAIN=100 OFFSET=0.5 AMPLITUDE=1 ROUT=7k COUT=1n
select=AMPLITUDE}
C {devices/lab_pin} 550 -860 0 0 {name=l16
lab=REF}
C {devices/lab_pin} 550 -920 0 0 {name=l15  lab=LED}
C {devices/lab_pin} 830 -890 0 1 {name=l18  lab=LEVEL}
C {ngspice/comp_ngspice} 950 -1000 0 0 {name=x4 GAIN=100 OFFSET=0.5 AMPLITUDE=1 ROUT=1 COUT=1p
select=OFFSET}
C {devices/lab_pin} 1060 -1000 0 1 {name=l19  lab=CTRL1 }
C {devices/lab_pin} 160 -450 0 0 {name=l20  lab=SUN }
C {devices/spice_probe} 850 -1030 0 1 {name=p4 analysis=tran}
C {devices/spice_probe} 810 -890 0 1 {name=p5 analysis=tran}
C {devices/spice_probe} 760 -670 0 0 {name=p6 analysis=tran}
C {devices/spice_probe} 160 -450 0 0 {name=p7 analysis=tran}
C {devices/lab_show} 440 -610 2 0 {name=l24}
C {devices/lab_pin} 1190 -670 0 0 {name=l25  lab=PANEL }
C {devices/scope2} 1190 -480 0 0 {name=l21
attach=l21}
C {devices/scope} 380 -610 0 0 {name=l22
attach=l22}
C {devices/scope_ammeter} 580 -360 0 0 {name=l23
attach=l23
device=Vcap}
C {devices/scope_ammeter} 620 -170 0 0 {name=l26
attach=l26
device=Vdiode}
