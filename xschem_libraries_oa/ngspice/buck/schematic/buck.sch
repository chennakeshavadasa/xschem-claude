...
C {devices/vsource} 60 -310 0 0 {name=Vin value="DC pwl 0 0 50u 5V"}
C {devices/title} 160 -30 0 0 {name=l1 author="Stefan Schippers"}
C {devices/gnd} 60 -220 0 0 {name=l2 lab=0}
C {devices/diode} 360 -370 2 0 {name=D1 model=BAR42 area=1}
C {devices/vsource} 210 -320 0 0 {name=Vpulse value="pulse -0.06 0.14 0 
+ 3.32u 3.32u 1f 6.67u"}
C {devices/vsource} 210 -260 0 0 {name=Vset value=3.3}
C {devices/ammeter} 490 -470 3 0 {name=Vmeas}
C {devices/capa} 570 -310 0 0 {name=C1
m=1
value=47u
footprint=1206
device="ceramic capacitor"}
C {devices/ammeter} 570 -370 0 0 {name=Vcap}
C {devices/ammeter} 690 -370 0 0 {name=Vload}
C {devices/res} 690 -310 0 0 {name=Rload
value=13.2
footprint=1206
device=resistor
m=1}
C {devices/ind} 430 -470 3 1 {name=L1
m=1
value=18u
footprint=1206
device=inductor}
C {devices/code_shown} 300 -890 0 0 {name=MODELS value=".MODEL BAR42 D(IS=1.139e-08 RS=0.99 CJO=9.3e-12
+ VJ=1.6 M=0.411 BV=30 EG=0.7 ) 
"}
C {devices/code_shown} 50 -910 0 0 {name=COMMANDS value="
.option savecurrents
.control
  save all
  tran 0.001us 0.5ms
...
.endc
"}
C {devices/lab_wire} 650 -470 0 0 {name=l3 sig_type=std_logic lab=nout}
C {devices/lab_wire} 350 -470 0 0 {name=l4 sig_type=std_logic lab=ndiode}
C {devices/lab_wire} 140 -470 0 0 {name=l5 sig_type=std_logic lab=nin}
C {devices/lab_wire} 210 -360 0 0 {name=l6 sig_type=std_logic lab=ntriangle}
C {devices/launcher} 90 -580 0 0 {name=h1
descr="Ctrl-click to go to Delorie's 
project page for info"
url="http://www.delorie.com/electronics/spice-stuff"}
C {devices/launcher} 850 -90 0 0 {name=h5
descr="load waves" 
tclcommand="xschem raw_read $netlist_dir/buck.raw tran"
}
C {devices/switch_ngspice} 210 -470 3 0 {name=S1 model=SW1
