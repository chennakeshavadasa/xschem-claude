...
C {devices/ipin} 220 -250 0 0 {name=p1 lab=A}
C {devices/title} 160 -30 0 0 {name=l1 author="Stefan Schippers"}
C {ngspice/inv_ngspice} 330 -200 0 0 {name=x1}
C {ngspice/inv_ngspice} 330 -300 0 1 {name=x2 RUP=300k RDOWN=200k}
C {devices/lab_pin} 400 -250 0 1 {name=l2 sig_type=std_logic lab=Y}
