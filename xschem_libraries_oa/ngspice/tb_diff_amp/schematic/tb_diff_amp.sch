...
C {devices/vsource} 80 -360 0 0 {name=V1 value=1.51 savecurrent=false}
C {devices/vsource} 180 -360 0 0 {name=V2 value=1.5 savecurrent=false}
C {devices/lab_pin} 60 -290 0 0 {name=p4 sig_type=std_logic lab=0}
C {devices/code_shown} 240 -320 0 0 {name=COMMANDS only_toplevel=false value="
...
.endc
"}
C {devices/launcher} 670 -120 0 0 {name=h5
descr="load waves" 
...
C {devices/launcher} 670 -170 0 0 {name=h1
descr="OP annotate" 
tclcommand="xschem annotate_op"
}
C {ngspice/diff_amp} 420 -490 0 0 {name=X1 model=diff_amp_cell gain=100 amplitude=5 offset=2.5
tclcommand="edit_file [abs_sym_path diff_amp.va]"}
C {devices/launcher} 450 -390 0 0 {name=h2
