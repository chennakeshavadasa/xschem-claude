...
N 500 -750 530 -750 {
lab=B}
C {devices/code_shown} 360 -420 0 0 {name=CONTROL_400w_voc_43
spice_ignore=false
only_toplevel=true
...
.endc
"}
C {devices/iopin} 640 -500 2 1 {name=p2 lab=minus}
C {devices/title} 160 -40 0 0 {name=l1 author="Stefan Schippers"}
C {devices/ipin} 100 -840 2 1 {name=p2 lab=fade}
C {devices/ammeter} 140 -750 3 0 {name=Vf}
C {devices/iopin} 640 -880 2 1 {name=p1 lab=plus}
C {devices/launcher} 1250 -160 0 0 {name=h3 
...
C {devices/launcher} 1250 -120 0 0 {name=h1 
...
C {devices/launcher} 1250 -70 0 0 {name=h2 
descr="Reload waves" 
tclcommand="
xschem raw_read $netlist_dir/[file tail [file rootname [xschem get current_name]]].raw
"
}
C {devices/ammeter} 640 -590 2 0 {name=Vm savecurrent=true}
C {devices/ammeter} 640 -830 2 0 {name=Vp savecurrent=true}
C {devices/diode} 210 -700 0 0 {name=D1 model=DPANEL area='area'

device_model=".model DPANEL D IS=1n N=1"}
C {devices/res} 340 -700 0 0 {name=Rp
value='rp'
footprint=1206
device=resistor
m=1}
C {devices/res} 470 -750 1 0 {name=Rs
value='rs'
footprint=1206
device=resistor
m=1
hide_texts=true}
C {devices/lab_pin} 80 -650 2 1 {name=l2 sig_type=std_logic lab=0}
C {devices/cccs} 540 -700 2 0 {name=F1 vnam=e1 value=1}
C {devices/vcvs} 640 -710 0 0 {name=E1 value="'n'"}
C {devices/lab_wire} 260 -750 0 0 {name=p3 sig_type=std_logic lab=A}
C {devices/lab_wire} 560 -750 0 0 {name=p4 sig_type=std_logic lab=B}
C {devices/ammeter} 130 -840 3 0 {name=Vf1}
C {devices/lab_pin} 160 -840 0 1 {name=p5 sig_type=std_logic lab=F}
C {devices/bsource} 110 -700 2 0 {name=B1 VAR=I FUNC="v(f) * isc"}
C {devices/ammeter} 310 -750 3 0 {name=Vr}
C {devices/ammeter} 400 -750 3 0 {name=Vm1 savecurrent=true}
C {devices/code_shown} 0 -410 0 0 {name=CONTROL_100w_voc_22
spice_ignore=true
only_toplevel=true
value=".param isc=6
.param n=36
...
.endc
"}
C {devices/lab_wire} 640 -770 0 0 {name=p6 sig_type=std_logic lab=ip}
C {devices/lab_wire} 640 -640 0 0 {name=p7 sig_type=std_logic lab=im}
C {devices/code_shown} -410 -410 0 0 {name=CONTROL_395w_voc_75.4
spice_ignore=true
only_toplevel=true
