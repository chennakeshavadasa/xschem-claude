...
C {devices/lab_pin} 800 -270 2 0 {name=l6 lab=BATT}
C {devices/lab_pin} 780 -100 0 0 {name=l2 lab=0}
C {devices/capa} 680 -150 0 0 {name=C1 m=1 value="30u ic=42" footprint=1206 device="ceramic capacitor"}
C {devices/lab_pin} 680 -100 0 0 {name=l7 lab=0}
C {devices/lab_wire} 530 -270 0 1 {name=l10 lab=DIODE}
C {devices/lab_pin} 80 -270 0 0 {name=l11 lab=SUPPLY}
...
C {devices/ipin} 170 -150 0 0 {name=p3 lab=PWM1}
C {devices/ammeter} 460 -270 3 1 {name=vm2}
C {devices/ammeter} 130 -270 3 1 {name=vm1}
C {devices/diode} 620 -270 3 1 {name=XD2 model=STPST15H100SB area=1
...
hide_texts=true
attach=XD2}
C {devices/nmos3} 350 -150 0 0 {name=xm3 model=irf540 m=1
program=evince
...
C {devices/lab_pin} 370 -100 0 0 {name=l3 lab=0}
C {devices/ind} 220 -270 3 0 {name=l8 value="50u ic=5"
hide_texts=true
attach=l8}
C {devices/res} 310 -270 3 0 {name=Rind1 value=0.05 footprint=1206 device=resistor m=1
hide_texts=true
attach=Rind1}
C {devices/ammeter} 370 -210 0 1 {name=vm3}
C {devices/lab_wire} 300 -150 0 1 {name=l4 lab=G1}
C {ngspice/buf_ngspice} 250 -150 0 0 {name=x1 RUP=20 RDOWN=20}
C {devices/lab_wire} 260 -270 0 1 {name=l5 lab=L1}
