...
C {xschem_simulator/nand2_1} 420 -2020 0 0 {name=x45 VGND=VGND VNB=VNB VPB=VPB VPWR=VPWR prefix=sky130_fd_sc_hd__ }
C {xschem_simulator/nand2_1} 650 -1760 0 0 {name=x49 VGND=VGND VNB=VNB VPB=VPB VPWR=VPWR prefix=sky130_fd_sc_hd__ }
C {xschem_simulator/nand3_1} 420 -1870 0 0 {name=x51 VGND=VGND VNB=VNB VPB=VPB VPWR=VPWR prefix=sky130_fd_sc_hd__ }
C {devices/ipin} 110 -1110 0 0 {name=p8 lab=CLK}
C {xschem_simulator/nand3_1} 420 -1500 0 0 {name=x46 VGND=VGND VNB=VNB VPB=VPB VPWR=VPWR prefix=sky130_fd_sc_hd__ }
C {xschem_simulator/nand3_1} 650 -1610 0 0 {name=x50 VGND=VGND VNB=VNB VPB=VPB VPWR=VPWR prefix=sky130_fd_sc_hd__ }
C {devices/ipin} 110 -1230 0 0 {name=p11 lab=CLEAR_}
C {xschem_simulator/nand3_1} 420 -1350 0 0 {name=x48 VGND=VGND VNB=VNB VPB=VPB VPWR=VPWR prefix=sky130_fd_sc_hd__ }
C {xschem_simulator/nand2_1} 1080 -2020 0 0 {name=x47 VGND=VGND VNB=VNB VPB=VPB VPWR=VPWR prefix=sky130_fd_sc_hd__ }
C {xschem_simulator/nand2_1} 1310 -1760 0 0 {name=x52 VGND=VGND VNB=VNB VPB=VPB VPWR=VPWR prefix=sky130_fd_sc_hd__ }
C {xschem_simulator/nand3_1} 1080 -1870 0 0 {name=x53 VGND=VGND VNB=VNB VPB=VPB VPWR=VPWR prefix=sky130_fd_sc_hd__ }
C {xschem_simulator/nand3_1} 1080 -1500 0 0 {name=x54 VGND=VGND VNB=VNB VPB=VPB VPWR=VPWR prefix=sky130_fd_sc_hd__ }
C {xschem_simulator/nand3_1} 1310 -1610 0 0 {name=x55 VGND=VGND VNB=VNB VPB=VPB VPWR=VPWR prefix=sky130_fd_sc_hd__ }
C {xschem_simulator/nand3_1} 1080 -1350 0 0 {name=x56 VGND=VGND VNB=VNB VPB=VPB VPWR=VPWR prefix=sky130_fd_sc_hd__ }
C {xschem_simulator/nand2_1} 1740 -2020 0 0 {name=x57 VGND=VGND VNB=VNB VPB=VPB VPWR=VPWR prefix=sky130_fd_sc_hd__ }
C {xschem_simulator/nand2_1} 1970 -1760 0 0 {name=x58 VGND=VGND VNB=VNB VPB=VPB VPWR=VPWR prefix=sky130_fd_sc_hd__ }
C {xschem_simulator/nand3_1} 1740 -1870 0 0 {name=x59 VGND=VGND VNB=VNB VPB=VPB VPWR=VPWR prefix=sky130_fd_sc_hd__ }
C {xschem_simulator/nand3_1} 1740 -1500 0 0 {name=x60 VGND=VGND VNB=VNB VPB=VPB VPWR=VPWR prefix=sky130_fd_sc_hd__ }
C {xschem_simulator/nand3_1} 1970 -1610 0 0 {name=x61 VGND=VGND VNB=VNB VPB=VPB VPWR=VPWR prefix=sky130_fd_sc_hd__ }
C {xschem_simulator/nand3_1} 1740 -1350 0 0 {name=x62 VGND=VGND VNB=VNB VPB=VPB VPWR=VPWR prefix=sky130_fd_sc_hd__ }
C {xschem_simulator/nand2_1} 2400 -2020 0 0 {name=x63 VGND=VGND VNB=VNB VPB=VPB VPWR=VPWR prefix=sky130_fd_sc_hd__ }
C {xschem_simulator/nand2_1} 2630 -1760 0 0 {name=x64 VGND=VGND VNB=VNB VPB=VPB VPWR=VPWR prefix=sky130_fd_sc_hd__ }
C {xschem_simulator/nand3_1} 2400 -1870 0 0 {name=x65 VGND=VGND VNB=VNB VPB=VPB VPWR=VPWR prefix=sky130_fd_sc_hd__ }
C {xschem_simulator/nand3_1} 2400 -1500 0 0 {name=x66 VGND=VGND VNB=VNB VPB=VPB VPWR=VPWR prefix=sky130_fd_sc_hd__ }
C {xschem_simulator/nand3_1} 2630 -1610 0 0 {name=x67 VGND=VGND VNB=VNB VPB=VPB VPWR=VPWR prefix=sky130_fd_sc_hd__ }
C {xschem_simulator/nand3_1} 2400 -1350 0 0 {name=x68 VGND=VGND VNB=VNB VPB=VPB VPWR=VPWR prefix=sky130_fd_sc_hd__ }
C {xschem_simulator/nand2_1} 3060 -2020 0 0 {name=x69 VGND=VGND VNB=VNB VPB=VPB VPWR=VPWR prefix=sky130_fd_sc_hd__ }
C {xschem_simulator/nand2_1} 3290 -1760 0 0 {name=x70 VGND=VGND VNB=VNB VPB=VPB VPWR=VPWR prefix=sky130_fd_sc_hd__ }
C {xschem_simulator/nand3_1} 3060 -1870 0 0 {name=x71 VGND=VGND VNB=VNB VPB=VPB VPWR=VPWR prefix=sky130_fd_sc_hd__ }
C {xschem_simulator/nand3_1} 3060 -1500 0 0 {name=x72 VGND=VGND VNB=VNB VPB=VPB VPWR=VPWR prefix=sky130_fd_sc_hd__ }
C {xschem_simulator/nand3_1} 3290 -1610 0 0 {name=x73 VGND=VGND VNB=VNB VPB=VPB VPWR=VPWR prefix=sky130_fd_sc_hd__ }
C {xschem_simulator/nand3_1} 3060 -1350 0 0 {name=x74 VGND=VGND VNB=VNB VPB=VPB VPWR=VPWR prefix=sky130_fd_sc_hd__ }
C {xschem_simulator/nand2_1} 4440 -2020 0 0 {name=x75 VGND=VGND VNB=VNB VPB=VPB VPWR=VPWR prefix=sky130_fd_sc_hd__ }
C {xschem_simulator/nand2_1} 4670 -1760 0 0 {name=x76 VGND=VGND VNB=VNB VPB=VPB VPWR=VPWR prefix=sky130_fd_sc_hd__ }
C {xschem_simulator/nand3_1} 4440 -1870 0 0 {name=x77 VGND=VGND VNB=VNB VPB=VPB VPWR=VPWR prefix=sky130_fd_sc_hd__ }
C {xschem_simulator/nand3_1} 4440 -1500 0 0 {name=x78 VGND=VGND VNB=VNB VPB=VPB VPWR=VPWR prefix=sky130_fd_sc_hd__ }
C {xschem_simulator/nand3_1} 4670 -1610 0 0 {name=x79 VGND=VGND VNB=VNB VPB=VPB VPWR=VPWR prefix=sky130_fd_sc_hd__ }
C {xschem_simulator/nand3_1} 4440 -1350 0 0 {name=x80 VGND=VGND VNB=VNB VPB=VPB VPWR=VPWR prefix=sky130_fd_sc_hd__ }
C {xschem_simulator/nand2_1} 5110 -2020 0 0 {name=x81 VGND=VGND VNB=VNB VPB=VPB VPWR=VPWR prefix=sky130_fd_sc_hd__ }
C {xschem_simulator/nand2_1} 5340 -1760 0 0 {name=x82 VGND=VGND VNB=VNB VPB=VPB VPWR=VPWR prefix=sky130_fd_sc_hd__ }
C {xschem_simulator/nand3_1} 5110 -1870 0 0 {name=x83 VGND=VGND VNB=VNB VPB=VPB VPWR=VPWR prefix=sky130_fd_sc_hd__ }
C {xschem_simulator/nand3_1} 5110 -1500 0 0 {name=x84 VGND=VGND VNB=VNB VPB=VPB VPWR=VPWR prefix=sky130_fd_sc_hd__ }
C {xschem_simulator/nand3_1} 5340 -1610 0 0 {name=x85 VGND=VGND VNB=VNB VPB=VPB VPWR=VPWR prefix=sky130_fd_sc_hd__ }
C {xschem_simulator/nand3_1} 5110 -1350 0 0 {name=x86 VGND=VGND VNB=VNB VPB=VPB VPWR=VPWR prefix=sky130_fd_sc_hd__ }
C {xschem_simulator/nand2_1} 5780 -2020 0 0 {name=x87 VGND=VGND VNB=VNB VPB=VPB VPWR=VPWR prefix=sky130_fd_sc_hd__ }
C {xschem_simulator/nand2_1} 6010 -1760 0 0 {name=x88 VGND=VGND VNB=VNB VPB=VPB VPWR=VPWR prefix=sky130_fd_sc_hd__ }
C {xschem_simulator/nand3_1} 5780 -1870 0 0 {name=x89 VGND=VGND VNB=VNB VPB=VPB VPWR=VPWR prefix=sky130_fd_sc_hd__ }
C {xschem_simulator/nand3_1} 5780 -1500 0 0 {name=x90 VGND=VGND VNB=VNB VPB=VPB VPWR=VPWR prefix=sky130_fd_sc_hd__ }
C {xschem_simulator/nand3_1} 6010 -1610 0 0 {name=x91 VGND=VGND VNB=VNB VPB=VPB VPWR=VPWR prefix=sky130_fd_sc_hd__ }
C {xschem_simulator/nand3_1} 5780 -1350 0 0 {name=x92 VGND=VGND VNB=VNB VPB=VPB VPWR=VPWR prefix=sky130_fd_sc_hd__ }
C {xschem_simulator/nand2_1} 6460 -2020 0 0 {name=x93 VGND=VGND VNB=VNB VPB=VPB VPWR=VPWR prefix=sky130_fd_sc_hd__ }
C {xschem_simulator/nand2_1} 6690 -1760 0 0 {name=x94 VGND=VGND VNB=VNB VPB=VPB VPWR=VPWR prefix=sky130_fd_sc_hd__ }
C {xschem_simulator/nand3_1} 6460 -1870 0 0 {name=x95 VGND=VGND VNB=VNB VPB=VPB VPWR=VPWR prefix=sky130_fd_sc_hd__ }
C {xschem_simulator/nand3_1} 6460 -1500 0 0 {name=x96 VGND=VGND VNB=VNB VPB=VPB VPWR=VPWR prefix=sky130_fd_sc_hd__ }
C {xschem_simulator/nand3_1} 6690 -1610 0 0 {name=x97 VGND=VGND VNB=VNB VPB=VPB VPWR=VPWR prefix=sky130_fd_sc_hd__ }
C {xschem_simulator/nand3_1} 6460 -1350 0 0 {name=x98 VGND=VGND VNB=VNB VPB=VPB VPWR=VPWR prefix=sky130_fd_sc_hd__ }
C {devices/lab_pin} 770 -1760 0 1 {name=l29 sig_type=std_logic lab=q1}
C {devices/lab_pin} 1430 -1760 0 1 {name=l30 sig_type=std_logic lab=q2}
C {devices/lab_pin} 2090 -1760 0 1 {name=l31 sig_type=std_logic lab=q3}
C {devices/lab_pin} 2760 -1760 0 1 {name=l32 sig_type=std_logic lab=q4}
C {devices/lab_pin} 4130 -1760 0 1 {name=l33 sig_type=std_logic lab=q5}
C {devices/lab_pin} 4800 -1760 0 1 {name=l34 sig_type=std_logic lab=q6}
C {devices/lab_pin} 5470 -1760 0 1 {name=l35 sig_type=std_logic lab=q7}
C {devices/lab_pin} 6150 -1760 0 1 {name=l36 sig_type=std_logic lab=q8}
C {devices/lab_pin} 6770 -1760 0 1 {name=l37 sig_type=std_logic lab=q9}
C {xschem_simulator/xor2_1} 5930 -2230 0 1 {name=x99 VGND=VGND VNB=VNB VPB=VPB VPWR=VPWR prefix=sky130_fd_sc_hd__ }
C {xschem_simulator/inv_2} 5260 -2230 2 0 {name=x100 VGND=GND VNB=GND VPB=VCC VPWR=VCC prefix=sky130_fd_sc_hd__ }
C {devices/title} 240 -50 0 0 {name=l38 author="Stefan Schippers"}
C {devices/launcher} 960 -370 0 0 {name=h3
...
C {xschem_simulator/giant_label2} 240 -3040 0 0 {name=l1 sig_type=std_logic lab=q1 text=M}
C {xschem_simulator/giant_label2} 880 -3040 0 0 {name=l2 sig_type=std_logic lab=q2 text=E}
C {xschem_simulator/giant_label2} 1520 -3040 0 0 {name=l3 sig_type=std_logic lab=q3 text=R}
C {xschem_simulator/giant_label2} 2160 -3040 0 0 {name=l4 sig_type=std_logic lab=q4 text=R}
C {xschem_simulator/giant_label2} 2800 -3040 0 0 {name=l5 sig_type=std_logic lab=q5 text=Y}
C {xschem_simulator/giant_label2} 4240 -3040 0 0 {name=l6 sig_type=std_logic lab=q6 text=X}
C {xschem_simulator/giant_label2} 4880 -3040 0 0 {name=l7 sig_type=std_logic lab=q7 text=M}
C {xschem_simulator/giant_label2} 5520 -3040 0 0 {name=l8 sig_type=std_logic lab=q8 text=A}
C {xschem_simulator/giant_label2} 6160 -3040 0 0 {name=l9 sig_type=std_logic lab=q9 text=S}
