...
C {devices/title} 1350 -50 0 0 {name=l38 author="Stefan Schippers"}
C {xschem_simulator/fa_1} 2280 -2670 0 0 {name=x28 VGND=VGND VNB=VNB VPB=VPB VPWR=VPWR prefix=sky130_fd_sc_hd__ }
C {xschem_simulator/fa_1} 2280 -2490 0 0 {name=x33 VGND=VGND VNB=VNB VPB=VPB VPWR=VPWR prefix=sky130_fd_sc_hd__ }
C {xschem_simulator/fa_1} 2280 -2310 0 0 {name=x34 VGND=VGND VNB=VNB VPB=VPB VPWR=VPWR prefix=sky130_fd_sc_hd__ }
C {xschem_simulator/fa_1} 2280 -2130 0 0 {name=x35 VGND=VGND VNB=VNB VPB=VPB VPWR=VPWR prefix=sky130_fd_sc_hd__ }
C {xschem_simulator/dfrtp_1} 3520 -2630 0 0 {name=x36 VGND=VGND VNB=VNB VPB=VPB VPWR=VPWR prefix=sky130_fd_sc_hd__ }
C {devices/lab_pin} 3690 -2650 0 1 {name=l34 sig_type=std_logic lab=B[3]}
C {xschem_simulator/dfrtp_1} 3520 -2450 0 0 {name=x37 VGND=VGND VNB=VNB VPB=VPB VPWR=VPWR prefix=sky130_fd_sc_hd__ }
C {devices/lab_pin} 3690 -2470 0 1 {name=l37 sig_type=std_logic lab=B[2]}
C {xschem_simulator/dfrtp_1} 3520 -2270 0 0 {name=x53 VGND=VGND VNB=VNB VPB=VPB VPWR=VPWR prefix=sky130_fd_sc_hd__ }
C {devices/lab_pin} 3690 -2290 0 1 {name=l41 sig_type=std_logic lab=B[1]}
C {xschem_simulator/dfrtp_1} 3520 -2090 0 0 {name=x54 VGND=VGND VNB=VNB VPB=VPB VPWR=VPWR prefix=sky130_fd_sc_hd__ }
C {devices/lab_pin} 3690 -2110 0 1 {name=l44 sig_type=std_logic lab=B[0]}
C {xschem_simulator/inv_2} 2050 -2180 0 0 {name=x55 VGND=VGND VNB=VNB VPB=VPB VPWR=VPWR prefix=sky130_fd_sc_hd__ }
C {devices/lab_pin} 2010 -2180 0 0 {name=l45 sig_type=std_logic lab=CLEAR_}
C {devices/noconn} 2360 -2710 0 1 {name=l46}
C {xschem_simulator/and2_1} 2700 -2630 0 0 {name=x59 VGND=VGND VNB=VNB VPB=VPB VPWR=VPWR prefix=sky130_fd_sc_hd__ }
C {xschem_simulator/and2_1} 2700 -2450 0 0 {name=x60 VGND=VGND VNB=VNB VPB=VPB VPWR=VPWR prefix=sky130_fd_sc_hd__ }
C {xschem_simulator/and2_1} 2700 -2270 0 0 {name=x61 VGND=VGND VNB=VNB VPB=VPB VPWR=VPWR prefix=sky130_fd_sc_hd__ }
C {xschem_simulator/and2_1} 2700 -2090 0 0 {name=x62 VGND=VGND VNB=VNB VPB=VPB VPWR=VPWR prefix=sky130_fd_sc_hd__ }
C {devices/lab_pin} 2490 -2650 0 0 {name=l51 sig_type=std_logic lab=BNEXT[3]}
C {devices/lab_pin} 2490 -2470 0 0 {name=l52 sig_type=std_logic lab=BNEXT[2]}
C {devices/lab_pin} 2490 -2290 0 0 {name=l53 sig_type=std_logic lab=BNEXT[1]}
C {devices/lab_pin} 2490 -2110 0 0 {name=l54 sig_type=std_logic lab=BNEXT[0]}
C {devices/launcher} 1840 -130 0 0 {name=h3
...
C {xschem_simulator/inv_2} 2620 -1960 0 0 {name=x1 VGND=VGND VNB=VNB VPB=VPB VPWR=VPWR prefix=sky130_fd_sc_hd__ }
C {xschem_simulator/giant_label} 1910 -1520 0 1 {name=l1 sig_type=std_logic lab=CLK text=CLK}
C {xschem_simulator/giant_label} 2660 -1960 0 1 {name=l3 sig_type=std_logic lab=R text="RESET
COUNTER"}
C {xschem_simulator/giant_label} 1900 -1280 0 1 {name=l4 sig_type=std_logic lab=CLEAR_ text="CLEAR (active low)"}
C {xschem_simulator/segment} 4560 -2230 0 0 {name=l6 sig_type=std_logic lab=S[3]}
C {xschem_simulator/segment} 4030 -2200 1 0 {name=l2 sig_type=std_logic lab=S[1]}
C {xschem_simulator/segment} 4530 -2200 3 1 {name=l5 sig_type=std_logic lab=S[2]}
C {xschem_simulator/segment} 4560 -2810 0 0 {name=l7 sig_type=std_logic lab=S[0]}
C {xschem_simulator/segment} 4530 -2180 3 0 {name=l8 sig_type=std_logic lab=S[5]}
C {xschem_simulator/segment} 4030 -2180 1 1 {name=l9 sig_type=std_logic lab=S[4]}
C {xschem_simulator/segment} 4000 -1570 2 0 {name=l10 sig_type=std_logic lab=S[6]}
C {devices/ipin} 1900 -1280 0 0 {name=p8 sig_type=std_logic lab=CLEAR_}
C {devices/ipin} 1910 -1520 0 0 {name=p9 sig_type=std_logic lab=CLK}
C {devices/lab_pin} 2330 -1940 0 0 {name=l11 sig_type=std_logic lab=BNEXT[3]}
C {devices/lab_pin} 2330 -1980 0 0 {name=l13 sig_type=std_logic lab=BNEXT[1]}
C {xschem_simulator/inv_2} 550 -3100 3 1 {name=x22 VGND=VGND VNB=VNB VPB=VPB VPWR=VPWR prefix=sky130_fd_sc_hd__ }
C {devices/lab_pin} 520 -3160 0 0 {name=l19 sig_type=std_logic lab=B[3]}
C {xschem_simulator/inv_2} 630 -3100 3 1 {name=x23 VGND=VGND VNB=VNB VPB=VPB VPWR=VPWR prefix=sky130_fd_sc_hd__ }
C {devices/lab_pin} 600 -3160 0 0 {name=l21 sig_type=std_logic lab=B[2]}
C {xschem_simulator/inv_2} 710 -3100 3 1 {name=x24 VGND=VGND VNB=VNB VPB=VPB VPWR=VPWR prefix=sky130_fd_sc_hd__ }
C {devices/lab_pin} 680 -3160 0 0 {name=l22 sig_type=std_logic lab=B[1]}
C {xschem_simulator/inv_2} 790 -3100 3 1 {name=x25 VGND=VGND VNB=VNB VPB=VPB VPWR=VPWR prefix=sky130_fd_sc_hd__ }
C {devices/lab_pin} 760 -3160 0 0 {name=l23 sig_type=std_logic lab=B[0]}
C {xschem_simulator/nand4_1} 940 -580 0 0 {name=x21 VGND=VGND VNB=VNB VPB=VPB VPWR=VPWR prefix=sky130_fd_sc_hd__ }
C {xschem_simulator/and4_1} 1110 -2420 0 0 {name=x38 VGND=VGND VNB=VNB VPB=VPB VPWR=VPWR prefix=sky130_fd_sc_hd__ }
C {xschem_simulator/nand4_1} 940 -2980 0 0 {name=x39 VGND=VGND VNB=VNB VPB=VPB VPWR=VPWR prefix=sky130_fd_sc_hd__ }
C {xschem_simulator/nand4_1} 940 -2820 0 0 {name=x40 VGND=VGND VNB=VNB VPB=VPB VPWR=VPWR prefix=sky130_fd_sc_hd__ }
C {xschem_simulator/and2_1} 1110 -2900 0 0 {name=x41 VGND=VGND VNB=VNB VPB=VPB VPWR=VPWR prefix=sky130_fd_sc_hd__ }
C {devices/lab_pin} 1230 -2900 0 1 {name=p4 lab=S[0]}
C {xschem_simulator/nand4_1} 940 -2500 0 0 {name=x42 VGND=VGND VNB=VNB VPB=VPB VPWR=VPWR prefix=sky130_fd_sc_hd__ }
C {xschem_simulator/nand4_1} 940 -2340 0 0 {name=x43 VGND=VGND VNB=VNB VPB=VPB VPWR=VPWR prefix=sky130_fd_sc_hd__ }
C {xschem_simulator/nand4_1} 940 -2180 0 0 {name=x44 VGND=VGND VNB=VNB VPB=VPB VPWR=VPWR prefix=sky130_fd_sc_hd__ }
C {xschem_simulator/nand4_1} 940 -2660 0 0 {name=x45 VGND=VGND VNB=VNB VPB=VPB VPWR=VPWR prefix=sky130_fd_sc_hd__ }
C {devices/lab_pin} 1230 -2420 0 1 {name=p5 lab=S[1]}
C {xschem_simulator/nand4_1} 940 -2020 0 0 {name=x46 VGND=VGND VNB=VNB VPB=VPB VPWR=VPWR prefix=sky130_fd_sc_hd__ }
C {xschem_simulator/nand4_1} 940 -1860 0 0 {name=x47 VGND=VGND VNB=VNB VPB=VPB VPWR=VPWR prefix=sky130_fd_sc_hd__ }
C {xschem_simulator/and2_1} 1110 -1940 0 0 {name=x48 VGND=VGND VNB=VNB VPB=VPB VPWR=VPWR prefix=sky130_fd_sc_hd__ }
C {devices/lab_pin} 1230 -1940 0 1 {name=p6 lab=S[2]}
C {xschem_simulator/nand4_1} 940 -1700 0 0 {name=x49 VGND=VGND VNB=VNB VPB=VPB VPWR=VPWR prefix=sky130_fd_sc_hd__ }
C {xschem_simulator/nand4_1} 940 -1540 0 0 {name=x50 VGND=VGND VNB=VNB VPB=VPB VPWR=VPWR prefix=sky130_fd_sc_hd__ }
C {xschem_simulator/nand4_1} 940 -1380 0 0 {name=x51 VGND=VGND VNB=VNB VPB=VPB VPWR=VPWR prefix=sky130_fd_sc_hd__ }
C {xschem_simulator/and3_1} 1110 -1540 0 0 {name=x52 VGND=VGND VNB=VNB VPB=VPB VPWR=VPWR prefix=sky130_fd_sc_hd__ }
C {devices/lab_pin} 1230 -1540 0 1 {name=p1 lab=S[3]}
C {xschem_simulator/and4_1} 940 -1220 0 0 {name=x18 VGND=VGND VNB=VNB VPB=VPB VPWR=VPWR prefix=sky130_fd_sc_hd__ }
C {xschem_simulator/and4_1} 940 -1060 0 0 {name=x19 VGND=VGND VNB=VNB VPB=VPB VPWR=VPWR prefix=sky130_fd_sc_hd__ }
C {xschem_simulator/and4_1} 940 -900 0 0 {name=x20 VGND=VGND VNB=VNB VPB=VPB VPWR=VPWR prefix=sky130_fd_sc_hd__ }
C {xschem_simulator/and4_1} 940 -740 0 0 {name=x26 VGND=VGND VNB=VNB VPB=VPB VPWR=VPWR prefix=sky130_fd_sc_hd__ }
C {xschem_simulator/or4_1} 1110 -980 0 0 {name=x27 VGND=VGND VNB=VNB VPB=VPB VPWR=VPWR prefix=sky130_fd_sc_hd__ }
C {devices/lab_pin} 1230 -980 0 1 {name=p2 lab=S[4]}
C {devices/lab_pin} 1230 -580 0 1 {name=p3 lab=S[5]}
C {xschem_simulator/nand4_1} 940 -420 0 0 {name=x29 VGND=VGND VNB=VNB VPB=VPB VPWR=VPWR prefix=sky130_fd_sc_hd__ }
C {xschem_simulator/nand4_1} 940 -260 0 0 {name=x30 VGND=VGND VNB=VNB VPB=VPB VPWR=VPWR prefix=sky130_fd_sc_hd__ }
C {xschem_simulator/nand4_1} 940 -100 0 0 {name=x31 VGND=VGND VNB=VNB VPB=VPB VPWR=VPWR prefix=sky130_fd_sc_hd__ }
C {xschem_simulator/and3_1} 1110 -260 0 0 {name=x32 VGND=VGND VNB=VNB VPB=VPB VPWR=VPWR prefix=sky130_fd_sc_hd__ }
C {devices/lab_pin} 1230 -260 0 1 {name=p7 lab=S[6]}
C {xschem_simulator/nand2_1} 2420 -1960 0 0 {name=x3 VGND=VGND VNB=VNB VPB=VPB VPWR=VPWR prefix=sky130_fd_sc_hd__ }
