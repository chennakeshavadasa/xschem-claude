...
C {devices/ipin} 70 -190 0 0 { name=p20 lab=A }
C {devices/ipin} 70 -150 0 0 { name=p5 lab=C }
C {devices/title} 160 -30 0 0 {name=l1 author="Stefan Schippers"}
C {devices/lab_pin} 50 -600 0 0 {name=p10 lab=A}
C {xschem_simulator/nand2_1} 110 -580 0 0 {name=x4 VGND=VGND VNB=VNB VPB=VPB VPWR=VPWR prefix=sky130_fd_sc_hd__ }
C {xschem_simulator/nand2_1} 290 -560 0 0 {name=x8 VGND=VGND VNB=VNB VPB=VPB VPWR=VPWR prefix=sky130_fd_sc_hd__ }
C {devices/lab_pin} 210 -540 0 0 {name=p9 lab=C}
C {xschem_simulator/einvp_1} 850 -400 0 0 {name=x1 VGND=VGND VNB=VNB VPB=VPB VPWR=VPWR prefix=sky130_fd_sc_hd__ }
C {xschem_simulator/nand2_1} 700 -270 1 0 {name=x10 VGND=VGND VNB=VNB VPB=VPB VPWR=VPWR prefix=sky130_fd_sc_hd__ }
C {xschem_simulator/einvp_1} 1340 -400 0 1 {name=x3 VGND=VGND VNB=VNB VPB=VPB VPWR=VPWR prefix=sky130_fd_sc_hd__ }
C {xschem_simulator/nand2_1} 1490 -270 3 1 {name=x11 VGND=VGND VNB=VNB VPB=VPB VPWR=VPWR prefix=sky130_fd_sc_hd__ }
C {xschem_simulator/dlrtp_1} 830 -690 0 0 {name=x15 VGND=VGND VNB=VNB VPB=VPB VPWR=VPWR prefix=sky130_fd_sc_hd__ }
C {xschem_simulator/dlrtn_1} 560 -690 0 0 {name=x16 VGND=VGND VNB=VNB VPB=VPB VPWR=VPWR prefix=sky130_fd_sc_hd__ }
C {xschem_simulator/dfrtp_1} 180 -720 0 0 {name=x13 VGND=VGND VNB=VNB VPB=VPB VPWR=VPWR prefix=sky130_fd_sc_hd__ }
C {xschem_simulator/inv_2} 170 -820 0 1 {name=x14 VGND=VGND VNB=VNB VPB=VPB VPWR=VPWR prefix=sky130_fd_sc_hd__ }
C {xschem_simulator/ntrans} 1820 -240 0 0 {name=m7 model=cmosn w=wn l=lln m=1}
C {xschem_simulator/ntrans} 1950 -190 0 0 {name=m8 model=cmosn w=wn l=lln m=1}
C {devices/lab_pin} 1690 -280 0 0 {name=p24 lab=A}
C {devices/lab_pin} 1690 -190 0 0 {name=p25 lab=B}
C {devices/lab_pin} 2030 -190 0 1 {name=p27 lab=GND}
C {devices/lab_pin} 1890 -240 0 1 {name=p30 lab=GND}
C {xschem_simulator/ptrans} 1820 -340 0 0 {name=m4 model=cmosp w=wp l=lp  m=1 }
C {xschem_simulator/ptrans} 1820 -440 0 0 {name=m9 model=cmosp w=wp l=lp  m=1 }
C {devices/lab_pin} 2020 -300 0 1 {name=p26 lab=Z}
C {devices/lab_pin} 1900 -440 0 1 {name=p31 lab=VCC}
C {devices/gnd} 1840 -140 0 0 {name=l3 lab=GND}
C {devices/vdd} 1840 -500 0 0 {name=l4 lab=VCC}
C {xschem_simulator/ptrans} 2330 -440 0 0 {name=m2 model=cmosp w=wp l=lp  m=1 }
C {xschem_simulator/ptrans} 2450 -380 0 0 {name=m3 model=cmosp w=wp l=lp  m=1 }
C {xschem_simulator/ntrans} 2370 -260 0 0 {name=m5 model=cmosn w=wn l=lln m=1}
C {xschem_simulator/ntrans} 2370 -170 0 0 {name=m6 model=cmosn w=wn l=lln m=1}
C {devices/lab_pin} 2440 -260 0 1 {name=p22 lab=GND}
C {devices/lab_pin} 2440 -170 0 1 {name=p28 lab=GND}
C {devices/lab_pin} 2410 -440 0 1 {name=p29 lab=VCC}
C {devices/lab_pin} 2530 -380 0 1 {name=p32 lab=VCC}
C {devices/vdd} 2400 -500 0 0 {name=l11 lab=VCC}
C {devices/gnd} 2390 -120 0 0 {name=l12 lab=GND}
C {devices/lab_pin} 2180 -310 0 0 {name=p21 lab=B}
C {devices/lab_pin} 2180 -350 0 0 {name=p23 lab=A}
C {xschem_simulator/inv_2} 660 -820 0 1 {name=x17 VGND=VGND VNB=VNB VPB=VPB VPWR=VPWR prefix=sky130_fd_sc_hd__ }
C {xschem_simulator/ntrans} 300 -1170 1 0 {name=m1 model=cmosn w=wn l=lln m=1}
C {devices/lab_pin} 300 -1150 1 1 {name=p6 lab=GND}
C {xschem_simulator/ptrans} 300 -1010 3 0 {name=m10 model=cmosp w=wp l=lp  m=1 }
C {devices/lab_pin} 300 -1030 3 1 {name=p18 lab=VCC}
C {xschem_simulator/inv_2} 210 -1220 0 0 {name=x18 VGND=VGND VNB=VNB VPB=VPB VPWR=VPWR prefix=sky130_fd_sc_hd__ }
C {xschem_simulator/ntrans} 300 -1430 1 0 {name=m11 model=cmosn w=wn l=lln m=1}
C {devices/lab_pin} 300 -1410 1 1 {name=p33 lab=GND}
C {xschem_simulator/ptrans} 300 -1270 3 0 {name=m12 model=cmosp w=wp l=lp  m=1 }
C {devices/lab_pin} 300 -1290 3 1 {name=p34 lab=VCC}
C {devices/vdd} 100 -1350 0 0 {name=l5 lab=VCC}
C {devices/gnd} 100 -1090 0 0 {name=l6 lab=GND}
C {xschem_simulator/ntrans} 650 -1170 3 1 {name=m13 model=cmosn w=wn l=lln m=1}
C {devices/lab_pin} 650 -1150 1 1 {name=p35 lab=GND}
C {xschem_simulator/ptrans} 650 -1010 1 1 {name=m14 model=cmosp w=wp l=lp  m=1 }
C {devices/lab_pin} 650 -1030 3 1 {name=p36 lab=VCC}
C {xschem_simulator/inv_2} 740 -1220 0 1 {name=x19 VGND=VGND VNB=VNB VPB=VPB VPWR=VPWR prefix=sky130_fd_sc_hd__ }
C {xschem_simulator/ntrans} 650 -1430 3 1 {name=m15 model=cmosn w=wn l=lln m=1}
C {devices/lab_pin} 650 -1410 1 1 {name=p37 lab=GND}
C {xschem_simulator/ptrans} 650 -1270 1 1 {name=m16 model=cmosp w=wp l=lp  m=1 }
C {devices/lab_pin} 650 -1290 3 1 {name=p38 lab=VCC}
C {devices/vdd} 850 -1350 0 1 {name=l7 lab=VCC}
C {devices/gnd} 850 -1090 0 1 {name=l8 lab=GND}
C {devices/lab_pin} 110 -1220 0 0 {name=p39 lab=E}
C {xschem_simulator/switch-1} 1370 -1320 0 0 {name=s4}
C {xschem_simulator/inv_2} 1370 -1250 0 0 {name=x20 VGND=VGND VNB=VNB VPB=VPB VPWR=VPWR prefix=sky130_fd_sc_hd__ }
C {xschem_simulator/diode_3} 1270 -1340 0 0 {name=x12 VTH=0.6 RON=10 ROFF=1G}
C {devices/ipin} 70 -170 0 0 { name=p19 lab=B }
C {xschem_simulator/dev-2} 1530 -680 0 1 {name=s3}
C {xschem_simulator/invert-1} 1370 -680 0 0 {name=s1}
C {xschem_simulator/dev-1} 1210 -680 0 0 {name=s2}
C {devices/vdd} 1080 -680 0 0 {name=l9 lab=VCC}
C {devices/lab_pin} 850 -1220 0 1 {name=p40 lab=E}
C {devices/ipin} 70 -130 0 0 { name=p69 lab=D }
C {xschem_simulator/nand2_1} 2180 -1400 0 0 {name=x45 VGND=VGND VNB=VNB VPB=VPB VPWR=VPWR prefix=sky130_fd_sc_hd__ }
C {xschem_simulator/nand2_1} 2410 -1200 0 0 {name=x49 VGND=VGND VNB=VNB VPB=VPB VPWR=VPWR prefix=sky130_fd_sc_hd__ }
C {xschem_simulator/nand3_1} 2180 -1250 0 0 {name=x51 VGND=VGND VNB=VNB VPB=VPB VPWR=VPWR prefix=sky130_fd_sc_hd__ }
C {xschem_simulator/nand3_1} 2180 -980 0 0 {name=x46 VGND=VGND VNB=VNB VPB=VPB VPWR=VPWR prefix=sky130_fd_sc_hd__ }
C {xschem_simulator/nand3_1} 2410 -1050 0 0 {name=x50 VGND=VGND VNB=VNB VPB=VPB VPWR=VPWR prefix=sky130_fd_sc_hd__ }
C {xschem_simulator/nand3_1} 2180 -830 0 0 {name=x48 VGND=VGND VNB=VNB VPB=VPB VPWR=VPWR prefix=sky130_fd_sc_hd__ }
C {devices/lab_pin} 2530 -1200 0 1 {name=l29 sig_type=std_logic lab=Q}
C {xschem_simulator/o21ai_1} 470 -460 0 0 {name=x5 VGND=VGND VNB=VNB VPB=VPB VPWR=VPWR prefix=sky130_fd_sc_hd__ }
C {devices/lab_pin} 280 -420 0 0 {name=p12 lab=D}
C {devices/lab_pin} 970 -710 0 1 {name=p13 lab=CK3}
C {devices/lab_pin} 290 -820 0 1 {name=p14 lab=CK2}
C {devices/lab_pin} 170 -460 0 0 {name=p15 lab=B}
C {devices/lab_pin} 370 -560 0 1 {name=p1 lab=E}
C {devices/lab_pin} 50 -560 0 0 {name=p2 lab=B}
C {devices/lab_pin} 590 -460 0 1 {name=p11 lab=G}
C {devices/lab_pin} 70 -740 0 0 {name=p4 lab=A}
C {devices/launcher} 70 -330 0 0 {name=h3
...
C {devices/lab_pin} 610 -380 0 0 {name=p16 lab=B}
C {devices/lab_pin} 1580 -380 0 1 {name=p17 lab=A}
C {devices/lab_pin} 1390 -270 0 1 {name=p70 lab=D}
C {devices/lab_pin} 1410 -400 0 1 {name=p71 lab=CK2}
C {devices/ipin} 70 -110 0 0 { name=p72 lab=RSTB }
C {devices/lab_pin} 50 -670 0 0 {name=p73 lab=RSTB}
C {devices/lab_pin} 1870 -710 0 0 {name=p3 lab=RSTB}
C {devices/lab_pin} 1880 -830 0 0 {name=p8 lab=C}
C {devices/lab_pin} 2010 -670 0 0 {name=p7 lab=A}
C {devices/lab_pin} 1270 -1440 0 0 {name=p74 lab=A}
C {devices/lab_pin} 1210 -820 0 0 {name=p41 lab=A}
C {devices/lab_pin} 1370 -820 0 0 {name=p42 lab=C}
C {devices/lab_pin} 1530 -820 0 0 {name=p43 lab=D}
C {devices/lab_pin} 780 -400 0 0 {name=p44 lab=CK3}
C {xschem_simulator/inv_2} 430 -380 0 0 {name=x2 VGND=VGND VNB=VNB VPB=VPB VPWR=VPWR prefix=sky130_fd_sc_hd__ }
C {devices/lab_pin} 470 -380 0 1 {name=p45 lab=DN}
C {devices/lab_pin} 810 -270 0 1 {name=p46 lab=DN}
