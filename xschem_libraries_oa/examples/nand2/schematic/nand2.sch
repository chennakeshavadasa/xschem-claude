...
C {devices/gnd} 180 -110 0 0 {name=l2 lab=VSS}
C {devices/vdd} 180 -500 0 0 {name=l1 lab=VCC}
...
C {devices/nmos4} 270 -310 0 0 {name=m1 model=CMOSN w=WN l=LLN m=1}
C {devices/nmos4} 270 -190 0 0 {name=m1 model=CMOSN w=WN l=LLN m=1}
C {devices/pmos4} 270 -440 0 0 {name=m2 model=CMOSP w=WP l=LP m=1}
C {devices/pmos4} 420 -440 0 0 {name=m2 model=CMOSP w=WP l=LP m=1}
