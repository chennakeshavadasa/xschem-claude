...
C {devices/launcher} 320 -100 0 0 {name=h1
...
C {devices/code_shown} 0 -930 0 0 {name=STIMULI
only_toplevel=true
...
.endc
"}
C {devices/capa} 150 -510 0 0 {name=C1 m=1 value=50nF footprint=1206 device="ceramic capacitor"}
C {devices/lab_pin} 150 -290 2 1 {name=l2 sig_type=std_logic lab=C}
C {devices/lab_pin} 150 -560 2 0 {name=l4 sig_type=std_logic lab=A}
C {devices/lab_pin} 350 -200 2 0 {name=l5 sig_type=std_logic lab=0}
C {devices/res} 350 -450 0 0 {name=R1 m=1 value=1k footprint=1206 device=resistor
}
C {devices/ind} 150 -350 0 0 {name=L1 value=10mH}
C {devices/vsource} 150 -230 0 0 {name=V1 
xvalue="pwl 0 0 100u 0 101u 3" 
value="pulse 0 3 0 100n 100n 9.9u 20u"

}
C {devices/ammeter} 350 -310 0 0 {name=Vmeas}
C {devices/lab_pin} 150 -450 2 0 {name=l6 sig_type=std_logic lab=B}
C {devices/lab_pin} 350 -380 2 0 {name=l7 sig_type=std_logic lab=D}
C {devices/launcher} 760 -90 0 0 {name=h5
descr="load waves" 
