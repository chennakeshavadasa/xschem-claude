...
C {devices/ipin} -150 10 0 0 {name=p3 lab=ENAB}
C {devices/iopin} -150 -10 0 1 {name=p2 lab=A sig_type=rreal}
C {devices/arch_declarations} 140 -160 0 0 {
...
C {devices/iopin} 150 -10 0 0 {name=p1 lab=B sig_type=rreal}
C {devices/use} -130 -260 0 0 {library ieee;
use std.TEXTIO.all;
