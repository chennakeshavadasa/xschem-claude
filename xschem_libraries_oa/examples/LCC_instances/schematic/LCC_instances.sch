...
N 410 -860 470 -860 {
lab=A}
C {devices/vsource} 50 -110 0 0 {name=V1 value="pwl 0 0 10u 3"
savecurrent=1
}
C {devices/lab_pin} 50 -180 0 0 {name=p4 lab=A}
C {devices/lab_pin} 50 -80 0 0 {name=p5 lab=0}
C {devices/code_shown} 510 -450 0 0 {name=STIMULI
only_toplevel=true
...
.endc
"}
C {devices/code} 1260 -170 0 0 {name=MODEL
only_toplevel="true"
tclcommand="xschem edit_vi_prop"
value="************************************************
...
"}
C {devices/lab_pin} 150 -190 0 0 {name=p6 lab=A}
C {devices/lab_pin} 400 -190 0 1 {name=p7 lab=ZZZ}
C {devices/vsource} 50 -240 0 0 {name=V2 value=3
savecurrent=1}
C {devices/lab_pin} 50 -210 0 0 {name=p9 lab=0}
C {devices/res} 340 -120 0 0 {name=R1
value=80k
footprint=1206
device=resistor
m=1}
C {devices/lab_pin} 340 -70 0 0 {name=p10 lab=HALF}
C {devices/vsource} 50 -370 0 0 {name=V3 value=1.5
savecurrent=1}
C {devices/lab_pin} 50 -420 0 0 {name=p11 lab=HALF}
C {devices/lab_pin} 50 -340 0 0 {name=p12 lab=0}
C {devices/lab_pin} 60 -490 0 0 {name=p13 lab=A}
C {devices/res} 1240 -410 0 0 {name=R2
value=80k
footprint=1206
device=resistor
m=1}
...
C {examples/cmos_inv} 510 -860 0 0 {name=Xinv1 WN=1u WP=1u LLN=2u LLP=2u}
C {devices/launcher} 655 -1115 0 0 {name=h1 
descr="load DC sim"
tclcommand="
xschem raw_read $netlist_dir/[file tail [file rootname [xschem get current_name]]].raw dc
"
}
C {devices/ammeter} 1350 -350 0 1 {name=Vmeas}
C {devices/vdd} 50 -280 0 0 {name=l2 lab=VDD}
C {devices/nmos4} 630 -840 3 0 {name=M1 model=n w=1u l=2u m=1}
C {devices/lab_pin} 630 -860 3 1 {name=l4 sig_type=std_logic lab=0}
C {devices/vdd} 680 -860 0 0 {name=l3 lab=VDD}
C {devices/launcher} 655 -1045 0 0 {name=h2 
descr="Annotate OP" 
tclcommand="
xschem annotate_op
"
}
C {devices/launcher} 885 -1115 0 0 {name=h3 
descr="load tran sim"
tclcommand="
