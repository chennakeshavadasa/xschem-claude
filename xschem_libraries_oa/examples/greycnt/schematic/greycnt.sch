...
C {examples/xnor} 660 -470 0 0 {name=x2}
C {examples/xnor} 660 -550 0 0 {name=x3}
C {examples/xnor} 660 -630 0 0 {name=x14}
C {devices/lab_pin} 830 -710 0 1 {name=p4 lab=B[7]}
C {devices/lab_pin} 830 -630 0 1 {name=p0 lab=B[6]}
...
C {examples/xnor} 660 -230 0 0 {name=x1}
C {examples/xnor} 660 -310 0 0 {name=x4}
C {examples/xnor} 660 -390 0 0 {name=x5}
...
C {examples/xnor} 660 -150 0 0 {name=x6}
C {devices/lab_pin} 830 -150 0 1 {name=p15 lab=B[0]}
C {devices/lab_pin} 150 -220 0 1 { name=l16 lab=B[7:0] }
C {devices/lab_pin} 90 -200 0 0 { name=l17 lab=A[7:0]  verilog_type=reg}
C {examples/xnor} 1060 -470 0 0 {name=x7}
C {examples/xnor} 1060 -550 0 0 {name=x8}
C {examples/xnor} 1060 -630 0 0 {name=x9}
C {devices/assign} 1060 -690 0 0 {name=v0 delay=1}
C {examples/xnor} 1060 -230 0 0 {name=x10}
C {examples/xnor} 1060 -310 0 0 {name=x11}
C {examples/xnor} 1060 -390 0 0 {name=x12}
C {examples/xnor} 1060 -150 0 0 {name=x13}
C {devices/lab_pin} 150 -190 0 1 { name=l26 lab=C[7:0] }
C {devices/use} 60 -770 0 0 {library ieee;
use std.TEXTIO.all;
...
C {devices/noconn} 90 -200 0 1 {name=l1}
C {devices/bus_tap} 1240 -140 3 0 {name=l2 lab=[0]}
C {devices/bus_tap} 1240 -220 3 0 {name=l4 lab=[1]}
C {devices/bus_tap} 1240 -300 3 0 {name=l5 lab=[2]}
C {devices/bus_tap} 1240 -380 3 0 {name=l6 lab=[3]}
C {devices/bus_tap} 1240 -460 3 0 {name=l7 lab=[4]}
C {devices/bus_tap} 1240 -540 3 0 {name=l8 lab=[5]}
C {devices/bus_tap} 1240 -620 3 0 {name=l9 lab=[6]}
C {devices/bus_tap} 1240 -700 3 0 {name=l10 lab=[7]}
C {devices/lab_pin} 1280 -100 0 1 {name=p16 lab=C[7:0]}
C {devices/bus_tap} 560 -120 1 1 {name=l11 lab=[0]}
C {devices/bus_tap} 560 -200 1 1 {name=l12 lab=[1]}
C {devices/bus_tap} 560 -280 1 1 {name=l13 lab=[2]}
C {devices/bus_tap} 560 -360 1 1 {name=l14 lab=[3]}
C {devices/bus_tap} 560 -440 1 1 {name=l15 lab=[4]}
C {devices/bus_tap} 560 -520 1 1 {name=l18 lab=[5]}
C {devices/bus_tap} 560 -600 1 1 {name=l19 lab=[6]}
C {devices/bus_tap} 560 -680 1 1 {name=l20 lab=[7]}
C {devices/lab_pin} 520 -80 0 0 {name=p1 lab=A[7:0]}
C {devices/launcher} 130 -430 0 0 {name=h5
descr="load waves" 
tclcommand="xschem raw_read $netlist_dir/greycnt.raw tran"
}
C {devices/simulator_commands} 240 -210 0 0 {name=COMMANDS
verilog_ignore=1
vhdl_ignore=1
...
"}
C {devices/simulator_commands} 370 -210 0 0 {name=COMMANDS1
verilog_ignore=1
vhdl_ignore=1
...
"}
C {devices/code} 240 -380 0 0 {name=VHDL 
only_toplevel=false 
spice_ignore=1
verilog_ignore=1
value="process
...
C {devices/code} 370 -380 0 0 {name=Verilog
only_toplevel=false
vhdl_ignore=1
spice_ignore=1
value="initial begin
