...
C {devices/launcher} 750 -90 0 0 {name=h1
...
C {devices/res} 50 -500 0 0 {name=R1
value=100MEG
footprint=1206
device=resistor
m=1
lvs_ignore=short}
C {devices/vdd} 50 -540 0 0 {name=l12 lab=VDD}
C {devices/capa} 50 -350 0 0 {name=C1
m=1
value=1p
footprint=1206
...
C {devices/vdd} 850 -580 0 0 {name=l6 lab=VDD}
C {devices/short} 520 -520 1 0 {name=x1 value=0.1 lvs_ignore=open}
C {devices/lab_show} 700 -520 0 1 {name=l2 }
