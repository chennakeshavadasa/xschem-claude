...
C {devices/ipin} 240 -330 0 0 {name=p1 lab=ibin[7:0]}
C {devices/opin} 400 -350 0 0 {name=p2 
lab=bcd2[1:0]
verilog_type=reg}
C {devices/title} 160 -30 0 0 {name=l1 author="Stefan Schippers"}
C {devices/opin} 400 -320 0 0 {name=p3
lab=bcd1[3:0]
verilog_type=reg}
C {devices/opin} 400 -290 0 0 {name=p4 lab=bcd0[3:0] verilog_type=reg}
C {devices/code} 260 -380 0 0 {name=CODE value="// Copyright (C) 2008 DJ Delorie <dj delorie com>
// Distributed under the terms of the GNU General Public License,
