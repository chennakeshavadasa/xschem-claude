...
C {devices/ipin} 330 -270 0 0 {name=p1 lab=ibcd[3:0]}
C {devices/opin} 500 -270 0 0 {name=p2 lab=oseg[6:0] verilog_type=reg}
C {devices/title} 160 -30 0 0 {name=l1 author="Stefan Schippers"}
C {devices/code} 360 -310 0 0 {name=CODE value="// Copyright (C) 2008 DJ Delorie <dj delorie com>
// Distributed under the terms of the GNU General Public License,
