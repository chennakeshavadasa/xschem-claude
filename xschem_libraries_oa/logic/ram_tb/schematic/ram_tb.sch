...
C {logic/ram} 740 -160 0 0 {name=x1 
dim=8 
width=16 
hex=1 
datafile=ram.list 
...
access_delay=3000 
oe_delay=300}
C {devices/lab_pin} 890 -220 0 1 {name=p1 lab=DOUT[15:0]}
C {devices/verilog_timescale} 40 -137.5 0 0 {name=s1 timestep="1ps" precision="1ps" }
C {devices/lab_pin} 590 -220 0 0 {name=p9 lab=ADD[7:0] verilog_type=reg}
C {devices/lab_pin} 590 -180 0 0 {name=p10 lab=DIN[15:0] verilog_type=reg}
C {devices/lab_pin} 590 -160 0 0 {name=p11 lab=WEN verilog_type=reg}
C {devices/lab_pin} 590 -120 0 0 {name=p12 lab=OEN verilog_type=reg}
C {devices/lab_pin} 590 -100 0 0 {name=p13 lab=CK verilog_type=reg}
C {devices/lab_pin} 590 -140 0 0 {name=p14 lab=CEN verilog_type=reg}
C {devices/lab_pin} 590 -200 0 0 {name=p15 lab=M[15:0] verilog_type=reg}
