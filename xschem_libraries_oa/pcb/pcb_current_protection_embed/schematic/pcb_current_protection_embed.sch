...
C {devices/code} 1060 -350 0 0 {name=STIMULI
tedax_ignore=true
only_toplevel=true
...
C {devices/lab_pin} 90 -280 0 1 {name=p8 lab=VCC
embed=true}
[
v {xschem version=3.1.0 file_version=1.2}
K {type=label
...
C {devices/conn_8x1} 70 -260 0 0 {name=C2
embed=true}
[
v {xschem version=3.1.0 file_version=1.2}
K {type=connector
...
C {devices/lab_pin} 90 -260 0 1 {name=p9 lab=VSS
embed=true}
C {pcb/lm358} 530 -270 0 0 {name=U3:1
spiceprefix=X
VCC=VCC 
VNN=VSS
...
C {devices/res} 360 -160 0 0 {name=R3 m=1 value=4k footprint=1206
embed=true}
[
v {xschem version=3.1.0 file_version=1.2}
K {type=resistor
...
C {devices/res} 360 -290 0 0 {name=R4 m=1 value=100k footprint=1206
embed=true}
C {devices/gnd} 360 -110 0 0 {name=l0 lab=VSS
embed=true}
[
v {xschem version=3.1.0 file_version=1.2}
K {type=label
...
C {devices/nmos} 930 -270 0 0 {name=M2
spiceprefix=X
embed=true}
[
v {xschem version=3.1.0 file_version=1.2}
...
C {devices/res} 950 -360 0 0 {name=R5 m=1 value=1 footprint=1206
embed=true}
C {devices/gnd} 950 -240 0 0 {name=l6 lab=VSS
embed=true}
C {devices/vdd} 360 -350 0 0 {name=l7 lab=VCC
embed=true}
[
v {xschem version=3.1.0 file_version=1.2}
K {type=label
...
C {devices/vdd} 950 -580 0 0 {name=l8 lab=VCC
embed=true}
C {devices/lab_pin} 950 -430 0 0 {name=p1 lab=VSSLOAD
embed=true}
C {devices/lab_pin} 360 -210 0 0 {name=p2 lab=VREF
embed=true}
C {devices/res} 950 -490 0 0 {name=RLOAD m=1 value="R='1/(time+1e-7)'" footprint=1206
embed=true}
C {devices/ammeter} 950 -550 0 0 {name=vmeasure
embed=true}
[
v {xschem version=3.1.0 file_version=1.2}
...
C {devices/lab_wire} 890 -270 0 0 {name=l12 lab=G
embed=true}
[
v {xschem version=3.1.0 file_version=1.2}
K {type=label
...
C {devices/lab_pin} 950 -320 0 0 {name=p3 lab=D
embed=true}
C {devices/res} 690 -270 1 0 {name=R2 m=1 value=20k footprint=1206
embed=true}
C {devices/npn} 720 -150 0 0 {name=Q1 model=q2n2222
...
C {devices/gnd} 740 -120 0 0 {name=l16 lab=VSS
embed=true}
C {devices/lab_pin} 590 -150 0 0 {name=p4 lab=RST
embed=true}
C {devices/res} 650 -150 1 0 {name=R6 m=1 value=20k footprint=1206
embed=true}
C {devices/lab_pin} 90 -240 0 1 {name=p5 lab=RST
embed=true}
C {devices/npn} 790 -200 0 0 {name=Q2 model=q2n2222
url="http://html.alldatasheet.com/html-pdf/17919/PHILIPS/MMBT2222/499/2/MMBT2222.html"
embed=true}
C {devices/gnd} 810 -170 0 0 {name=l11 lab=VSS
embed=true}
C {devices/res} 810 -280 2 0 {name=R1 m=1 value=20k footprint=1206
embed=true}
C {devices/vdd} 810 -310 0 0 {name=l13 lab=VCC
embed=true}
C {devices/launcher} 370 -520 0 0 {name=h5
descr="load waves" 
