...
C {pcb/74ls00} 420 -350 0 0 {name=U1:2  risedel=100 falldel=200 embed=true}
[
v {xschem version=3.0.0 file_version=1.2}
G {type=nand
...
C {pcb/74ls00} 870 -440 0 0 {name=U1:1  risedel=100 falldel=200 embed=true}
[
v {xschem version=3.0.0 file_version=1.2}
G {type=nand
format="@name @pinlist @value"
...
C {devices/lab_pin} 970 -440 0 1 {name=p0 lab=OUTPUT_Y}
C {devices/capa} 590 -160 0 0 {name=C0 m=1 value=100u device="electrolitic capacitor" embed=true}
[
v {xschem version=3.0.0 file_version=1.2}
G {type=capacitor
...
C {pcb/74ls00} 420 -460 0 0 {name=U1:4 risedel=100 falldel=200 power=VCC5
...
C {pcb/7805} 730 -190 0 0 {name=U0 url="https://www.sparkfun.com/datasheets/Components/LM7805.pdf" embed=true}
[
v {xschem version=3.0.0 file_version=1.2}
G {type=regulator
...
C {devices/capa} 890 -160 0 0 {name=C4 m=1 value=10u device="tantalium capacitor"}
C {devices/res} 520 -190 1 0 {name=R0 m=1 value=4.7 device="carbon resistor" embed=true}
[
v {xschem version=3.0.0 file_version=1.2}
G {type=resistor
...
C {devices/lab_wire} 700 -460 0 0 {name=l3 lab=A}
C {devices/lab_wire} 700 -420 0 0 {name=l0 lab=B}
C {devices/lab_wire} 650 -190 0 0 {name=l1 lab=VCCFILT embed=true}
[
v {xschem version=3.0.0 file_version=1.2}
G {type=label
format="*.alias @lab"
...
C {devices/lab_pin} 310 -370 0 0 {name=lONN1 lab=INPUT_A verilog_type=reg}
C {devices/lab_pin} 310 -330 0 0 {name=lONN2 lab=INPUT_B verilog_type=reg}
C {devices/lab_pin} 40 -330 0 1 { name=lONN3 lab=OUTPUT_Y }
C {devices/lab_pin} 310 -480 0 0 {name=lONN6 lab=INPUT_E verilog_type=reg}
C {devices/lab_pin} 310 -440 0 0 {name=lONN8 lab=INPUT_F verilog_type=reg}
C {devices/lab_pin} 40 -310 0 1 { name=lONN9 lab=VCC12 }
C {devices/lab_pin} 40 -290 0 1 { name=lONN14 lab=ANALOG_GND  verilog_type=reg}
C {devices/lab_pin} 40 -270 0 1 { name=lONN15 lab=GND  verilog_type=reg embed=true}
[
v {xschem version=3.0.0 file_version=1.2}
G {type=label
format="*.alias @lab"
...
C {devices/verilog_timescale} 1050 -100 0 0 {name=s1 timestep="1ns" precision="1ns"  embed=true}
[
v {xschem version=3.0.0 file_version=1.2}
G {type=timescale
spice_ignore=true
...
C {devices/conn_8x1} 20 -390 0 0 {name=C1 footprint=connector(8,1) embed=true}
[
v {xschem version=3.0.0 file_version=1.2}
G {type=connector
verilog_ignore=true
...
C {devices/lab_pin} 40 -370 0 1 {name=l4 lab=INPUT_A verilog_type=reg}
C {devices/lab_pin} 40 -350 0 1 {name=l5 lab=INPUT_B verilog_type=reg}
C {devices/lab_pin} 40 -410 0 1 {name=l6 lab=INPUT_E verilog_type=reg}
C {devices/lab_pin} 40 -390 0 1 {name=l7 lab=INPUT_F verilog_type=reg}
