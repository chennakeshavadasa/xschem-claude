...
C {pcb/74ls00} 420 -350 0 0 {name=U1:2  risedel=100 falldel=200}
C {pcb/74ls00} 870 -440 0 0 {name=U1:1  risedel=100 falldel=200}
C {devices/lab_pin} 970 -440 0 1 {name=p0 lab=OUTPUT_Y}
C {pcb/74ls00} 420 -460 0 0 {name=U1:4 risedel=100 falldel=200
...
C {devices/res} 520 -190 1 0 {name=R0 m=1 value=4.7 device="carbonresistor"}
...
C {devices/lab_pin} 40 -270 0 1 { name=lONN15 lab=GND  verilog_type=reg}
...
C {devices/conn_8x1} 20 -390 0 0 {name=C1 footprint=connector(8,1)}
...
C {devices/capa} 590 -160 0 0 {name=C0 m=1 value=100u device="electrolitic capacitor"}
