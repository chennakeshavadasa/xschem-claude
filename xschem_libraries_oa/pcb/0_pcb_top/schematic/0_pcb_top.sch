...
C {devices/launcher} 450 -270 0 0 {name=h1 
descr="XSCHEM ON REPO.HU" 
url="http://repo.hu/projects/xschem"
program=x-www-browser}
C {devices/launcher} 450 -320 0 0 {name=h2 
descr="LOCAL DOCUMENTATION" 
url="$\{XSCHEM_SHAREDIR\}/../doc/xschem/index.html"
program=x-www-browser

}
C {devices/launcher} 450 -220 0 0 {name=h3 
descr="Toggle light/dark 
colorscheme" 
tclcommand="xschem toggle_colorscheme"
}
C {devices/zener} 920 -190 0 0 {name=x10 model=XXX device=XXX}
C {pcb/pcb_current_protection} 170 -460 0 0 {name=x1}
C {pcb/pcb_voltage_protection} 170 -420 0 0 {name=x0}
C {pcb/pcb_test1} 170 -380 0 0 {name=x2}
C {pcb/hierarchical_tedax} 170 -340 0 0 {name=x3}
