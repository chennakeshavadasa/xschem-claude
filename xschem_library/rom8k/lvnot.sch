...
C {p.sym} 400 -370 0 0 {name=m2 model=cmosp w=wp l=lp  m=1 }
C {lab_pin.sym} 420 -420 0 0 {name=p149 lab=VCCPIN}
C {lab_pin.sym} 420 -90 0 0 {name=p3 lab=VSSPIN}
C {n.sym} 400 -140 0 0 {name=m1 model=cmosn w=wn l=lln m=1}
...
C {ammeter.sym} 420 -300 0 0 {name=Vmeas savecurrent=true spice_ignore=0}
C {ammeter.sym} 420 -210 0 0 {name=Vmeas1 savecurrent=true spice_ignore=0}
C {lab_pin.sym} 420 -180 0 0 {name=p4 sig_type=std_logic lab=DN}
C {lab_pin.sym} 420 -330 0 0 {name=p5 sig_type=std_logic lab=DP}
C {spice_probe.sym} 420 -330 2 0 {name=p95 analysis=tran}
C {spice_probe.sym} 420 -180 0 1 {name=p6 analysis=tran}
