...
C {examples/nr2-1} 690 -280 0 0 {name=E3 TABLE="'VTH-0.1' VHI 'VTH+0.1' 0.0"}
...
C {examples/inv_bsource} 340 -370 0 0 {name=B5 TABLE="'VTH-0.1' VHI 'VTH+0.1' 0"}
C {examples/inv_bsource} 340 -220 0 0 {name=B1 TABLE="'VTH-0.1' VHI 'VTH+0.1' 0"}
