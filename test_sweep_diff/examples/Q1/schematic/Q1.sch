...
C {devices/code} 10 -190 0 0 {name=MODELS value="* This is the BJT model used in the Agilent MSA-26 model
...
device=resistor 
m=1}
C {devices/res} 440 -190 0 0 {name=Re value=2.158 footprint=1206 device=resistor m=1}
...
C {devices/capa} 260 -290 0 0 {name=Ceox 
m=1 
value=6.01e-15
footprint=1206 
device="ceramic capacitor"}
