...
N 850 -380 980 -380 {
lab=NET_E}
C {devices/lab_pin} 130 -290 0 0 {name=p3 sig_type=std_logic lab=NET_A}
C {devices/ipin} 100 -190 0 0 { name=p4 lab=NET_D }
C {devices/title} 160 -30 0 0 {name=l1
author="Stefan Schippers"
}
C {devices/short} 330 -390 1 0 {name=x2
spice_ignore="tcleval([if \{$IGNORE == 1\} \{return \{false\}\} else \{return \{true\}\}])"
}
C {devices/lab_pin} 660 -290 0 1 {name=p5 sig_type=std_logic lab=NET_B}
C {devices/lab_show} 480 -390 0 1 {name=l2 }
C {devices/lab_pin} 60 -480 0 0 {name=p1 sig_type=std_logic lab=NET_C}
C {devices/short} 330 -580 1 0 {name=x5
...
C {devices/lab_show} 1020 -380 0 1 {name=l4 }
C {devices/launcher} 830 -100 0 0 {name=h1
...
"}
C {devices/ammeter} 90 -480 3 0 {name=Vopt2
spice_ignore="tcleval([if \{$IGNORE == 1\} \{return \{true\}\} else \{return \{short\}\}])"
}
C {devices/lab_pin} 60 -420 0 0 {name=p2 sig_type=std_logic lab=NET_D}
C {devices/ammeter} 90 -420 3 0 {name=Vopt1
...
C {devices/lab_show} 1380 -590 0 1 {name=l8 }
C {devices/ipin} 100 -210 0 0 { name=p10 lab=NET_A }
