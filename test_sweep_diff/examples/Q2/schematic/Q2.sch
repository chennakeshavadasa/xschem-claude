...
C {devices/code} 40 -210 0 0 {name=MODELS value="* This is the BJT model used in the Agilent MSA-26 model
...
"}
C {devices/res} 440 -630 0 0 {name=Rcx
value="1.716
+ TC1=0.113e-2" 
footprint=1206 
device=resistor 
m=1}
C {devices/res} 440 -190 0 0 {name=Re value=0.443 footprint=1206 device=resistor m=1}
C {devices/res} 190 -380 3 1 {name=Rbx
value="0.463 
+ TC1=0.14e-2" 
footprint=1206 
device=resistor 
m=1}
C {devices/npn} 420 -380 0 0 {name=Q1 
model=BJTM1_Q2
device=BJTM1_Q2 
footprint=SOT23 
area=4
pinnumber(B)=2
pinnumber(E)=1}
C {devices/diode} 310 -460 3 0 {name=D1 
model=DiodeM1_Q2
area=1}
C {devices/capa} 310 -560 3 0 {name=Ccox
m=1 
value=6.598e-14 
footprint=1206 
device="ceramic capacitor"}
C {devices/iopin} 440 -720 0 0 {name=p1 lab=P3}
C {devices/iopin} 440 -100 0 0 {name=p2 lab=P1}
C {devices/capa} 250 -290 0 0 {name=Ceox 
m=1 
value=2.417e-14
footprint=1206 
device="ceramic capacitor"}
C {devices/iopin} 60 -380 0 1 {name=p3 lab=P2}
C {devices/diode} 340 -290 0 0 {name=D2
model=DiodeM2_Q2 
area=1}
C {devices/title} 160 -30 0 0 {name=l1 author="Stefan Schippers"}
C {devices/lab_pin} 440 -430 0 1 {name=l2 sig_type=std_logic lab=C}
C {devices/lab_pin} 440 -310 0 1 {name=l3 sig_type=std_logic lab=E}
C {devices/lab_wire} 300 -380 0 1 {name=l4 sig_type=std_logic lab=B}
