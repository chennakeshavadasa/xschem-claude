...
C {devices/ipin} 140 -190 0 0 {name=p0 lab=PLUS}
C {devices/ipin} 140 -150 0 0 {name=p2 lab=VPP}
C {devices/ipin} 140 -130 0 0 {name=p3 lab=VNN}
C {devices/title} 160 -30 0 0 {name=l2 author="Stefan Schippers"}
C {devices/opin} 210 -160 0 0 {name=p5 lab=OUT}
C {devices/ipin} 140 -210 0 0 {name=p1 lab=MINUS}
C {devices/ipin} 140 -170 0 0 {name=p4 lab=VSS}
C {devices/noconn} 140 -210 2 0 {name=l1}
C {devices/noconn} 140 -190 2 0 {name=l3}
C {devices/noconn} 140 -170 2 0 {name=l4}
C {devices/noconn} 140 -150 2 0 {name=l5}
C {devices/noconn} 140 -130 2 0 {name=l6}
C {devices/noconn} 210 -160 2 1 {name=l7}
