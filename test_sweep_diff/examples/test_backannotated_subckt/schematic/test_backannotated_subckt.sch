...
C {devices/lab_pin} 680 -170 0 1 {name=p1 lab=OUT}
C {devices/lab_pin} 380 -170 0 0 {name=p2 lab=IN}
C {devices/title} 160 -30 0 0 {name=l1 author="tcleval([
...
C {devices/vsource} 140 -160 0 0 {name=V1 value="pwl 0 0 10n 0 11n 5"}
C {devices/lab_pin} 140 -100 0 0 {name=l2 sig_type=std_logic lab=0}
C {devices/lab_pin} 160 -210 0 1 {name=p3 lab=IN}
C {examples/rcline} 530 -170 0 0 {name=x1 L=1e-4 W=0.5e-6
}
C {devices/code_shown} 830 -190 0 0 {name=STIMULI
only_toplevel=false 
...
.endc
"}
C {devices/launcher} 1050 -230 0 0 {name=h5
descr="load waves" 
