...
C {devices/ipin} 210 -280 0 0 {name=p1 lab=A[3:0]}
C {devices/ipin} 210 -190 0 0 {name=p3 lab=B}
C {devices/opin} 810 -250 0 0 {name=p4 lab=Z}
C {devices/ipin} 330 -150 0 0 {name=p5 lab=RST}
C {devices/ipin} 360 -240 0 0 {name=p7 lab=CK}
C {devices/use} 380 -480 0 0 {------------------------------------------------
library ieee;
