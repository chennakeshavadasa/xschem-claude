...
C {devices/lab_pin} 750 -300 0 0 {name=p20 lab=0}
C {devices/lab_pin} 30 -150 0 0 {name=p17 lab=0}
...
C {devices/lab_pin} 620 -430 0 1 {name=p6 lab=VCC}
C {devices/pmos4} 450 -430 0 1 {name=m6 model=cmosp w=5u l=2u m=1}
C {devices/lab_pin} 380 -430 0 0 {name=p7 lab=VCC}
...
C {devices/lab_pin} 830 -360 0 1 {name=p11 lab=DIFFOUT}
C {devices/lab_pin} 240 -230 0 0 {name=p13 lab=GN}
C {devices/lab_pin} 30 -280 0 0 {name=p14 lab=0}
C {devices/vsource} 30 -310 0 0 {name=VPLUS value=2.5
}
C {devices/lab_pin} 60 -370 0 1 {name=p15 lab=PLUS}
C {devices/lab_pin} 30 -430 0 0 {name=p16 lab=0}
C {devices/vsource} 30 -460 0 0 {name=V1 value=2.5}
C {devices/lab_pin} 60 -520 0 1 {name=p18 lab=MINUS}
C {devices/capa} 750 -330 0 0 {name=CL
m=1
value=2p
footprint=1206
...
"}
C {devices/ngspice_probe} 500 -210 0 0 {name=r9}
C {devices/lab_pin} 430 -370 0 0 {name=p12 lab=G}
C {devices/lab_pin} 500 -230 0 0 {name=p19 lab=S}
C {devices/launcher} 1100 -200 0 0 {name=h3 
