...
N 990 -490 990 -430 {
lab=DIFFOUT}
C {devices/lab_pin} 30 -220 0 0 {name=p17 lab=0}
C {devices/title} 160 -30 0 0 {name=l1 author="Stefan Schippers"}
C {devices/nmos4} 550 -160 0 0 {name=m1 model=cmosn w=5u l=2u m=2
}
C {devices/pmos4} 670 -490 0 0 {name=m2 model=cmosp w=5u l=2u m=1
}
C {devices/vsource} 30 -250 0 0 {name=VVCC value='VCC'
}
C {devices/lab_pin} 570 -100 0 0 {name=p1 lab=0}
C {devices/lab_pin} 60 -310 0 1 {name=p2 lab=VCC}
C {devices/nmos4} 280 -160 0 1 {name=m3 model=cmosn w=5u l=2u m=1
}
C {devices/lab_pin} 260 -100 0 0 {name=p3 lab=0}
C {devices/isource} 260 -270 0 0 {name=IBIAS value='IB'
}
C {devices/lab_pin} 260 -300 0 0 {name=p4 lab=0}
C {devices/nmos4} 480 -290 0 0 {name=m4 model=cmosn w=10u l=1u m=1
}
C {devices/lab_pin} 520 -290 0 1 {name=p5 lab=0}
C {devices/nmos4} 710 -290 0 1 {name=m5 model=cmosn w=10u l=1u m=1
}
C {devices/lab_pin} 670 -290 0 0 {name=p0 lab=0}
C {devices/lab_pin} 740 -490 0 1 {name=p6 lab=VCC}
C {devices/pmos4} 520 -490 0 1 {name=m6 model=cmosp w=5u l=2u m=1
}
C {devices/lab_pin} 450 -490 0 0 {name=p7 lab=VCC}
C {devices/lab_pin} 570 -580 0 0 {name=p8 lab=VCC}
C {devices/lab_pin} 750 -290 0 1 {name=p9 lab=PLUS}
C {devices/lab_pin} 440 -290 0 0 {name=p10 lab=MINUS}
C {devices/lab_pin} 840 -420 0 1 {name=p11 lab=DIFFOUT}
C {devices/lab_pin} 260 -220 0 0 {name=p13 lab=GN}
C {devices/lab_pin} 30 -500 0 0 {name=p16 lab=0}
C {devices/vsource} 30 -530 0 0 {name=VPLUS value="dc 2.5 pwl 0 2.5 100n 2.5 100.1n 2.51"
}
C {devices/lab_pin} 60 -590 0 1 {name=p18 lab=PLUS}
C {devices/lab_pin} 500 -430 0 0 {name=p12 lab=G}
C {devices/launcher} 700 -60 0 0 {name=h1
descr=Backannotate
tclcommand="
...
C {devices/launcher} 700 -110 0 0 {name=h2
descr="View raw file"
tclcommand="textwindow $netlist_dir/cmos_example_ngspice.raw"}
C {devices/ammeter} 690 -370 0 1 {name=Vmeasr}
C {devices/simulator_commands} 60 -830 0 0 {name=COMMANDS
simulator=ngspice
only_toplevel=true 
value=".temp 30
...
"}
C {devices/ammeter} 500 -370 0 1 {name=Vmeasl}
C {devices/lab_pin} 570 -230 0 0 {name=p19 lab=S}
C {devices/nmos4} 1140 -160 0 0 {name=m7 model=cmosn w=5u l=2u m=1
device_model="
*n-ch model
.MODEL CMOSN NMOS (
+LEVEL   = 49             acm     = 3
...
+LKETA   = -0.018518       )
"}
C {devices/lab_pin} 1160 -100 0 0 {name=p21 lab=0}
C {devices/lab_pin} 1060 -160 0 0 {name=p22 lab=GN}
C {devices/pmos4} 1140 -490 0 0 {name=m8 model=cmosp w=5u l=2u m=1
device_model="
*p-ch model
.MODEL CMOSP PMOS (
+LEVEL   = 49             acm     = 3
...
+LKETA   = 7.702974E-3     )
"}
C {devices/lab_pin} 1210 -490 0 1 {name=p23 lab=VCC}
C {devices/lab_pin} 1260 -330 0 1 {name=p24 lab=OUT
lock=1}
C {devices/launcher} 2000 -100 0 0 {name=h5
descr="load waves" 
...
C {devices/launcher} 1750 -100 0 0 {name=h3
descr="Simulate" 
tclcommand="simulate"
}
C {devices/res} 990 -380 0 0 {name=R1
value=70k
footprint=1206
device=resistor
m=1}
C {devices/capa} 990 -320 0 0 {name=C1
m=1
value=200f
footprint=1206
device="ceramic capacitor"}
C {devices/lab_pin} 520 -790 0 0 {name=p20 lab=MINUS}
C {devices/lab_pin} 750 -1040 2 0 {name=l18 lab=S}
C {devices/lab_pin} 710 -1040 2 0 {name=l19 lab=0}
C {devices/lab_pin} 680 -980 1 0 {name=l20 lab=0}
C {devices/vcvs} 730 -980 1 0 {name=e1 value=1}
C {devices/lab_pin} 750 -1180 2 0 {name=l2 lab=G}
C {devices/lab_pin} 710 -1180 2 0 {name=l3 lab=0}
C {devices/lab_pin} 680 -1120 1 0 {name=l4 lab=0}
C {devices/vcvs} 730 -1120 1 0 {name=e2 value=1}
C {devices/lab_pin} 900 -1050 0 0 {name=p25 lab=0}
C {devices/lab_pin} 980 -790 0 1 {name=p27 lab=OUT}
C {devices/nmos4} 920 -1050 0 1 {name=m10 model=cmosn w=10u l=1u m=1
}
C {devices/res} 890 -790 1 0 {name=R3
value=10G
m=1}
C {devices/capa} 840 -730 0 0 {name=C3
m=1
value=1
footprint=1206
device="ceramic capacitor"}
C {devices/vcvs} 730 -750 0 1 {name=e3 value=1}
C {devices/lab_pin} 730 -700 0 0 {name=l8 lab=0}
C {devices/vsource} 590 -790 3 0 {name=VLOOP value="dc 0 ac 1 0"
}
C {devices/launcher} 1480 -100 0 0 {name=h4
descr="netlist" 
