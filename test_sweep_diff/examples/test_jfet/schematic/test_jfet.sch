...
C {devices/code_shown} 580 -280 0 0 {name=COMMANDS only_toplevel=false value="VG G 0 dc 0
VD D 0 dc 0
...
C {devices/launcher} 980 -290 0 0 {name=h5
descr="load waves" 
...
C {devices/code} 40 -440 0 0 {name=MODEL only_toplevel=false value=".MODEL 2N3459 NJF(VTO=-1.4 BETA=1.265m BETATCE=-0.5 LAMBDA=4m RD=1 RS=1 CGS=2.916p CGD=2.8p PB=0.5 IS=114.5f XTI=3 AF=1 FC=0.5 N=1 NR=2)
