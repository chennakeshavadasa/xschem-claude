...
C {devices/code_shown} 0 -340 0 0 {name=COMMANDS only_toplevel=false value="tcleval(
...
C {examples/test_evaluated_param} 750 -150 0 0 {name=x1 DEL=5
schematic=test_evaluated_param2.sch}
C {devices/lab_pin} 950 -150 0 1 {name=p1 lab=Z2}
C {devices/title} 160 -30 0 0 {name=l1 author="Stefan Schippers"}
C {devices/vsource} 520 -110 0 0 {name=V1 value="tcleval(pwl 0 0 10n 0 11n $VCC)" savecurrent=false}
C {devices/gnd} 520 -80 0 0 {name=l2 lab=GND}
C {devices/lab_pin} 520 -150 0 0 {name=p2 lab=A}
C {examples/test_evaluated_param} 750 -250 0 0 {name=x2 DEL=2
schematic=test_evaluated_param1.sch}
C {devices/lab_pin} 950 -250 0 1 {name=p3 lab=Z1}
C {devices/launcher} 960 -310 0 0 {name=h5
descr="load waves" 
