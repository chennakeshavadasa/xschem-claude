...
C {devices/nmos4} 430 -150 0 0 {name=m1 model=cmosn w=5u l=2u m=1}
C {devices/pmos4} 500 -400 0 0 {name=mtop_2nd model=cmosp w=5u l=2u m=1}
C {devices/vsource} 30 -180 0 0 {name=VVCC value=5}
C {devices/lab_pin} 450 -90 0 0 {name=p1 lab=0}
C {devices/lab_pin} 60 -240 0 1 {name=p2 lab=VCC}
C {devices/nmos4} 210 -150 0 1 {name=m3 model=cmosn w=5u l=2u m=1}
C {devices/lab_pin} 190 -90 0 0 {name=p3 lab=0}
C {devices/isource} 190 -260 0 0 {name=IBIAS value=10u}
C {devices/lab_pin} 190 -290 0 0 {name=p4 lab=0}
C {devices/nmos4} 360 -250 0 0 {name=m4 model=cmosn w=10u l=1u m=1}
C {devices/lab_pin} 400 -250 0 1 {name=p5 lab=0}
C {devices/nmos4} 540 -250 0 1 {name=m5 model=cmosn w=10u l=1u m=1}
C {devices/lab_pin} 500 -250 0 0 {name=p0 lab=0}
C {devices/lab_pin} 570 -400 0 1 {name=p6 lab=VCC}
C {devices/pmos4} 400 -400 0 1 {name=mtop_1st model=cmosp w=5u l=2u m=1}
C {devices/lab_pin} 330 -400 0 0 {name=p7 lab=VCC}
C {devices/lab_pin} 450 -490 0 0 {name=p8 lab=VCC}
C {devices/lab_pin} 320 -250 0 0 {name=p9 lab=PLUS}
C {devices/lab_pin} 580 -250 0 1 {name=p10 lab=MINUS}
C {devices/lab_pin} 900 -330 0 1 {name=p11 lab=DIFFOUT}
C {devices/lab_pin} 190 -200 0 0 {name=p13 lab=GN}
C {devices/lab_pin} 30 -280 0 0 {name=p14 lab=0}
C {devices/vsource} 30 -310 0 0 {name=VPLUS value="dc 2.5"
}
C {devices/lab_pin} 60 -370 0 1 {name=p15 lab=PLUS}
C {devices/code} 10 -550 0 0 {name=STIMULI
only_toplevel=true
value="
...
"}
C {devices/lab_pin} 790 -570 0 0 {name=l18 lab=DIFFOUT}
C {devices/lab_pin} 790 -530 0 0 {name=l19 lab=0}
C {devices/lab_pin} 830 -500 0 0 {name=l20 lab=0}
C {devices/lab_pin} 830 -600 0 1 {name=l21 lab=DIFFOUT_L}
C {devices/vcvs} 830 -550 0 0 {name=e1 value=1}
C {devices/lab_pin} 750 -140 0 0 {name=p12 lab=0}
C {devices/lab_pin} 450 -200 0 0 {name=p16 lab=D}
C {devices/lab_pin} 610 -570 0 0 {name=l2 lab=D}
C {devices/lab_pin} 610 -530 0 0 {name=l3 lab=0}
C {devices/lab_pin} 650 -500 0 0 {name=l4 lab=0}
C {devices/lab_pin} 650 -600 0 1 {name=l5 lab=D_L}
C {devices/vcvs} 650 -550 0 0 {name=e2 value=1}
C {devices/nmos4} 810 -420 0 1 {name=m7 model=cmosn w=10u l=1u m=1}
C {devices/lab_pin} 790 -470 0 0 {name=l6 lab=DIFFOUT_L}
C {devices/lab_pin} 790 -370 0 0 {name=l7 lab=D_L}
C {devices/lab_pin} 790 -420 0 0 {name=p18 lab=0}
C {devices/vsource} 690 -230 3 0 {name=VLOOP value="dc 0 ac 1 0"}
C {devices/res} 750 -190 0 0 {name=R2
value=10G
m=1}
C {devices/ind} 850 -250 1 0 {name=L1
m=1
value=100k
footprint=1206
device=inductor}
C {devices/launcher} 1040 -580 0 0 {name=h2
descr="View raw file"
tclcommand="textwindow $netlist_dir/[file tail [file rootname [xschem get current_name]]].raw"
}
C {devices/launcher} 1040 -770 0 0 {name=h5 
...
C {devices/capa} 800 -190 0 0 {name=C1
m=1
value=1
footprint=1206
device="ceramic capacitor"}
C {devices/launcher} 1040 -670 0 0 {name=h1 
...
C {devices/launcher} 1210 -70 0 0 {name=h3
