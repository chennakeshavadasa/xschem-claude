...
.endc
"}
C {devices/lab_pin} 140 -680 0 0 {name=p1 lab=VCC}
C {devices/res} 140 -620 0 1 {name=Rs m=1 value=1}
C {devices/vsource} 140 -510 0 1 {name=Vvcc value="pwl 0 0 1u 12"}
C {devices/lab_pin} 140 -460 0 0 {name=p7 lab=VSS}
C {devices/capa} 230 -510 0 0 {name=Cvcc m=1 value=10u}
...
C {devices/lab_pin} 140 -570 0 0 {name=p6 lab=VCCS}
...
C {devices/ind} 790 -460 0 1 {name=L2 value=9.1m}
C {devices/k} 700 -460 0 0 {name=K0 K=0.15 L1=L1 L2=L2}
C {devices/res} 790 -370 0 0 {name=R0 m=1 value=.32}
...
C {devices/launcher} 100 -810 0 0 {name=h5 
...
C {devices/launcher} 170 -90 0 0 {name=h6
