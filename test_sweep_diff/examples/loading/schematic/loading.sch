...
C {devices/lab_pin} 110 -500 0 0 { name=p1 lab=SW2 }
C {devices/lab_pin} 110 -520 0 0 { name=p2 lab=SW1 }
C {devices/lab_pin} 110 -540 0 0 { name=p3 lab=SW }
C {devices/lab_pin} 110 -560 0 0 { name=p4 lab=ING1 }
C {devices/lab_pin} 110 -580 0 0 { name=p5 lab=ING }
C {devices/noconn} 110 -580 0 1 {name=l10}
C {devices/noconn} 110 -560 0 1 {name=l11}
C {devices/noconn} 110 -540 0 1 {name=l12}
C {devices/noconn} 110 -520 0 1 {name=l13}
C {devices/noconn} 110 -500 0 1 {name=l14}
