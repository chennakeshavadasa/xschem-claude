...
C {devices/opin} 340 -220 0 0 {name=p10 lab=DOUT[width-1:0] verilog_type=wire
sim_pinnumber=8}
C {devices/ipin} 200 -220 0 0 {name=p8 lab=DIN[width-1:0]
sim_pinnumber=5}
C {devices/ipin} 200 -110 0 0 {name=p12 lab=CK
sim_pinnumber=1}
C {devices/ipin} 200 -140 0 0 {name=p1 lab=OEN
sim_pinnumber=2}
C {devices/ipin} 200 -260 0 0 {name=p3 lab=ADD[dim-1:0]
sim_pinnumber=7}
C {devices/ipin} 200 -190 0 0 {name=p2 lab=WEN
sim_pinnumber=4}
C {devices/ipin} 200 -170 0 0 {name=p4 lab=CEN
sim_pinnumber=3}
C {devices/ipin} 200 -240 0 0 {name=p5 lab=M[width-1:0]
sim_pinnumber=6}
C {devices/verilog_timescale} 710 -197.5 0 0 {name=s1 timestep="1ps" precision="1ps" }
C {devices/title} 160 -30 0 0 {name=l2}
C {devices/use} 360 -130 0 0 {------------------------------------------------
library ieee;
        use ieee.std_logic_1164.all;
        use ieee.numeric_std.all;}
C {devices/arch_declarations} 750 -630 0 0 {    constant RAM_DEPTH :integer := 2**dim;
