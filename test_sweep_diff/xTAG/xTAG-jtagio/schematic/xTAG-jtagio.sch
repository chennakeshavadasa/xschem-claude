...
C {xTAG/7414} 570 -870 0 1 {name=U20:1 
power=jtag_power 
ground=GND}
C {xTAG/7414} 570 -750 0 0 {name=U20:2 
power=jtag_power 
ground=GND}
C {xTAG/7414} 570 -630 0 0 {name=U20:3 
power=jtag_power 
ground=GND}
C {xTAG/7414} 570 -510 0 0 {name=U20:4 
power=jtag_power 
ground=GND}
C {xTAG/7414} 570 -390 0 0 {name=U20:5 
power=jtag_power 
ground=GND}
C {devices/conn_8x1} 1030 -670 0 1 {name=CONN4 footprint=conn_jtag}
C {devices/noconn} 990 -530 0 0 {name=l2}
C {devices/gnd} 950 -510 0 0 {name=l3 lab=GND}
C {devices/opin} 260 -1030 0 1 {name=p1 lab=jtag_power}
C {devices/opin} 260 -870 0 1 {name=p2 lab=tdi_ttl}
C {devices/ipin} 260 -750 0 0 {name=p3 lab=tdo_ttl}
C {devices/ipin} 260 -630 0 0 {name=p4 lab=tms_ttl}
C {devices/ipin} 260 -510 0 0 {name=p5 lab=tck_ttl}
C {devices/ipin} 260 -390 0 0 {name=p6 lab=trst_ttl}
C {devices/capa} 1130 -950 0 0 {name=C20
m=1
value=100n
footprint=sm1206
device="ceramic capacitor"}
C {devices/lab_pin} 1130 -1000 0 0 {name=l4 sig_type=std_logic lab=jtag_power}
C {devices/gnd} 1130 -900 0 0 {name=l5 lab=GND}
C {devices/res} 480 -960 0 0 {name=R23
value=10k
footprint=sm0805
device=resistor
m=1}
C {devices/res} 420 -960 0 0 {name=R22
value=10k
footprint=sm0805
device=resistor
m=1}
C {devices/res} 360 -960 0 0 {name=R21
value=10k
footprint=sm0805
device=resistor
m=1}
C {devices/res} 300 -960 0 0 {name=R20
value=10k
footprint=sm0805
device=resistor
m=1}
