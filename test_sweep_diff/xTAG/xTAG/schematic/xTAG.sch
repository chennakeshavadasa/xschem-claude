...
C {xTAG/xTAG-psu} 630 -780 0 0 {name=x4}
C {xTAG/xTAG-jtagio} 280 -480 0 0 {name=x2}
C {devices/lab_pin} 280 -780 0 0 {name=l4 sig_type=std_logic lab=jtag_power}
C {devices/lab_wire} 470 -520 0 1 {name=p1 lab=tdi_ttl}
C {devices/lab_wire} 470 -500 0 1 {name=p1 lab=tdo_ttl}
C {devices/lab_wire} 470 -480 0 1 {name=p1 lab=tms_ttl}
C {devices/lab_wire} 470 -460 0 1 {name=p1 lab=tck_ttl}
C {devices/lab_wire} 470 -440 0 1 {name=p1 lab=trst_ttl}
C {xTAG/xTAG-ucont} 820 -480 0 0 {name=x1}
C {xTAG/xTAG-consio} 1230 -480 0 0 {name=x3}
C {devices/title} 160 -30 0 0 {name=l1 author="Stefan Schippers"}
C {devices/lab_wire} 1060 -480 0 0 {name=p2 lab=usb_iop}
C {devices/lab_wire} 1060 -440 0 0 {name=p3 lab=usb_iom}
C {devices/lab_pin} 1020 -750 0 1 {name=l2 lab=pon_reset_}
C {devices/lab_pin} 1230 -780 0 1 {name=p5 lab=usb_power}
