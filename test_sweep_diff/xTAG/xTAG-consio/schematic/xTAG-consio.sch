...
C {devices/conn_4x1} 260 -710 0 0 {name=CONN2 footprint=conn_usb}
C {xTAG/sn75240pw} 690 -530 0 0 {name=U1}
C {devices/gnd} 300 -660 0 0 {name=l2 lab=GND}
C {devices/opin} 360 -740 0 0 {name=p1 lab=usb_power}
C {devices/gnd} 410 -400 0 0 {name=l3 lab=GND}
C {devices/gnd} 950 -400 0 1 {name=l4 lab=GND}
C {devices/noconn} 890 -510 0 1 {name=l5}
C {devices/noconn} 890 -590 0 1 {name=l6}
C {devices/opin} 270 -550 0 1 {name=p2 lab=usb_iom}
C {devices/opin} 270 -470 0 1 {name=p3 lab=usb_iop}
